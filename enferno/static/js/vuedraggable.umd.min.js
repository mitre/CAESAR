(function (t, e) {
  "object" === typeof exports && "object" === typeof module
    ? (module.exports = e(require("sortablejs")))
    : "function" === typeof define && define.amd
      ? define(["sortablejs"], e)
      : "object" === typeof exports
        ? (exports["vuedraggable"] = e(require("sortablejs")))
        : (t["vuedraggable"] = e(t["Sortable"]));
  ...
  return (function (t) {
    ...
    "01f9": function (t, e, n) {
      ...
      t.exports = function (t, e, n, b, m, y, x) {
        a(n, e, b);
        var O,
          S,
          w,
          ...
          L = _[l] || _[p] || (m && _[m]),
          I = L || j(m),
          E = m ? (C ? j("entries") : I) : void 0,
          P = ("Array" == e && _.entries) || L;
        if (
          (P &&
            ((w = f(P.call(new t()))),
            w !== Object.prototype &&
              w.next &&
              (s(w, M, !0), r || "function" == typeof w[l] || c(w, l, g))),
          C &&
            L &&
            L.name !== v &&
            ((T = !0),
          ...
          if (
            ((O = { values: C ? I : j(v), keys: y ? I : j(h), entries: E }), x)
          )
            for (S in O) S in _ || i(_, S, O[S]);
          else o(o.P + o.F * (d || T), e, O);
        return O;
      };
    },
    "02f4": function (t, e, n) {
      ...
      (n("8378").inspectSource = function (t) {
        ...
        (t.exports = function (t, e, n, u) {
          ...
          a && (i(n, "name") || o(n, "name", e)),
            t[e] !== n &&
              (a && (i(n, c) || o(n, c, t[e] ? "" + t[e] : s.join(String(e)))),
              t === r
                ? (t[e] = n)
                : u
                  ? t[e]
    ...
    "2aeb": function (t, e, n) {
      ...
      t.exports =
        ...
        function (t, e) {
          ...
          return (
            null !== t
              ? ((u[a] = r(t)), (n = new u()), (u[a] = null), (n[c] = t))
              : (n = s()),
            void 0 === e ? n : o(n, e)
          );
        };
      ...
      f &&
        (c = function (t) {
          ...
          return (
            ...
            a && (e = l[u]),
            (c = o.call(l, t)),
            a && c && (l[u] = l.global ? c.index + c[0].length : e),
            s &&
              c &&
              c.length > 1 &&
          ...
          ? function (t, e) {
              ...
              while (a > s) {
                var d,
                  ...
                  v = h.length,
                  g = 0;
                while (v > g) l.call(p, (d = h[g++])) && (n[d] = p[d]);
              }
              return n;
            }
          : a;
        ...
        return [
          ...
          function (t, e) {
            ...
            while (1) {
              ...
              if ((y.push(x), !b)) break;
              var O = String(x[0]);
              "" === O && (l.lastIndex = u(d, i(l.lastIndex), m));
            }
            for (var S = "", w = 0, j = 0; j < y.length; j++) {
              x = y[j];
              for (
                var M = String(x[0]),
                  C = s(f(c(x.index), d.length), 0),
                  T = [],
                  _ = 1;
                _ < x.length;
                _++
              ...
              var L = x.groups;
              if (p) {
                var I = [M].concat(T, C, d);
                void 0 !== L && I.push(L);
                var E = String(e.apply(void 0, I));
              } else E = g(M, d, C, T, L, e);
              C >= w && ((S += d.slice(w, C) + E), (w = C + M.length));
            }
            return S + d.slice(w);
          },
        ];
    ...
    ac6a: function (t, e, n) {
      for (
        ...
        var g,
          ...
          y = c[b],
          x = y && y.prototype;
        if (x && (x[f] || u(x, f, d), x[l] || u(x, l, b), (a[b] = d), m))
    ...
    ce10: function (t, e, n) {
      ...
      t.exports = function (t, e) {
        ...
        while (e.length > a) r(u, (n = e[a++])) && (~i(s, n) || s.push(n));
        return s;
      };
    },
    d2c8: function (t, e, n) {
    ...
    fb15: function (t, e, n) {
      ...
      function M(t, e, n) {
        var r = 0,
          o = 0,
          i = j(e, n, "header");
        i && ((r = i.length), (t = t ? [].concat(p(i), p(t)) : p(i)));
        var c = j(e, n, "footer");
        return (
          c && ((o = c.length), (t = t ? [].concat(p(t), p(c)) : p(c))),
          { children: t, headerOffset: r, footerOffset: o }
        );
      }
      function C(t, e) {
        var n = null,
        ...
        var i = e.on,
          c = e.props,
          u = e.attrs;
        return r("on", i), r("props", c), Object.assign(n.attrs, u), n;
      }
      var T = ["Start", "Add", "Remove", "Update", "End"],
        _ = ["Choose", "Unchoose", "Sort", "Filter", "Clone"],
        L = ["Move"].concat(T, _).map(function (t) {
          return "on" + t;
        }),
        I = null,
        E = {
        ...
        P = {
          ...
          render: function (t) {
            ...
            this.transitionMode = w(e);
            var n = M(e, this.$slots, this.$scopedSlots),
              r = n.children,
              o = n.headerOffset,
              i = n.footerOffset;
            (this.headerOffset = o), (this.footerOffset = i);
            var c = C(this.$attrs, this.componentData);
          ...
          methods: {
            ...
            updateOptions: function (t) {
              for (var e in t) {
                var n = Object(g["a"])(e);
                -1 === L.indexOf(n) && this._sortable.option(n, t[e]);
              }
            },
            ...
            getUnderlyingPotencialDraggableComponent: function (t) {
              var e = t.__vue__;
              return e && e.$options && S(e.$options._componentTag)
                ? e.$parent
                : !("realList" in e) &&
                    1 === e.$children.length &&
            ...
            computeFutureIndex: function (t, e) {
              ...
              var n = p(e.to.children).filter(function (t) {
