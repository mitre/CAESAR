!(function (e, t) {
  ...
  var xe = me.hasStandardBrowserEnv
    ? (function () {
        var e,
        ...
        return new Promise(function (t, n) {
          ...
          if (G.isFormData(a))
            if (me.hasStandardBrowserEnv || me.hasStandardBrowserWebWorkerEnv)
              ...
              var m = o
                ...
                b = y.slice(1);
              s.setContentType(
                [v || "multipart/form-data"].concat(u(b)).join("; "),
              );
            }
          ...
          if (
            (g.open(
              ...
              se(E, e.params, e.paramsSerializer),
              !0,
            ),
            (g.timeout = e.timeout),
            "onloadend" in g
            ...
            (g.onabort = function () {
              g &&
                (n(new $("Request aborted", $.ECONNABORTED, e, g)), (g = null));
            }),
            (g.onerror = function () {
            ...
            var R = xe(E) && e.xsrfCookieName && Ne.read(e.xsrfCookieName);
          ...
          void 0 === a && s.setContentType(null),
            ...
            d && "json" !== d && (g.responseType = e.responseType),
            "function" == typeof e.onDownloadProgress &&
              g.addEventListener("progress", ke(e.onDownloadProgress, !0)),
            "function" == typeof e.onUploadProgress &&
              g.upload &&
              g.upload.addEventListener("progress", ke(e.onUploadProgress)),
            (e.cancelToken || e.signal) &&
              ((r = function (t) {
                g &&
                  (n(!t || t.type ? new Pe(null, e, g) : t),
                  g.abort(),
                  (g = null));
              }),
          ...
          var A,
            j = ((A = /^([-+\w]{1,25})(:?\/\/|:)/.exec(E)) && A[1]) || "";
          j && -1 === me.protocols.indexOf(j)
  ...
  var Ue = function (e) {
    ...
    Fe = function (e) {
      for (
        ...
        if (
          ((n = t = e[i]),
          !De(t) && void 0 === (n = _e[(a = String(t)).toLowerCase()]))
        )
  ...
  function Le(e) {
    return (
      ...
      Fe(e.adapter || be.adapter)(e).then(
        function (t) {
          return (
            Be(e),
      ...
      return (
        i(e, [
          ...
          },
          {
            ...
            value: function (e) {
              return se(
                Ce((e = qe(this.defaults, e)).baseURL, e.url),
                e.params,
                e.paramsSerializer,
              );
            },
