!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = t(require("zxcvbn")))
    : "function" == typeof define && define.amd
      ? define("Password", ["zxcvbn"], t)
      : "object" == typeof exports
        ? (exports.Password = t(require("zxcvbn")))
        : (e.Password = t(e.zxcvbn));
})(this, function (e) {
  return (function (e) {
    function t(r) {
    ...
    function (e, t, s) {
      ...
      t.default = {
        ...
        props: {
          ...
          badge: { type: Boolean, default: !0 },
          toggle: { type: Boolean, default: !1 },
          showPassword: { type: Boolean, default: !1 },
          referenceValue: { type: String, default: "input" },
          showStrengthMeter: { type: Boolean, default: !0 },
          strengthMeterOnly: { type: Boolean, default: !1 },
          defaultClass: { type: String, default: "Password__field" },
          disabledClass: { type: String, default: "Password__field--disabled" },
          errorClass: { type: String, default: "Password__badge--error" },
          successClass: { type: String, default: "Password__badge--success" },
          strengthMeterClass: {
            type: String,
          ...
          labelShow: { type: String, default: "Show Password" },
          labelHide: { type: String, default: "Hide Password" },
          userInputs: {
            type: Array,
            default: function () {
              return [];
        ...
        data: function () {
          return { password: null, _showPassword: !1 };
        },
        methods: {
          togglePassword: function () {
            this.$data._showPassword
              ? (this.$emit("hide"), (this.$data._showPassword = !1))
              : (this.$emit("show"), (this.$data._showPassword = !0));
          },
        ...
        watch: {
          ...
          passwordStrength: function (e) {
            this.$emit("score", e),
              this.$emit("feedback", (0, o.default)(this.password).feedback);
          },
        },
      };
    },
    ...
    function (e, t) {
      e.exports = function (e, t, s, r, n) {
        ...
        t && ((d.render = t.render), (d.staticRenderFns = t.staticRenderFns)),
          r && (d._scopeId = r);
        var u;
        if (
          (n
      ...
      e.exports = {
        render: function () {
          var e = this,
            t = e.$createElement,
            s = e._self._c || t;
          return s("div", { staticClass: "Password" }, [
            e.strengthMeterOnly
              ? e._e()
              : s("div", { staticClass: "Password__group" }, [
                  s(
                    "input",
                    e._b(
                      {
                        ...
                        class: [
                          e.defaultClass,
                          e.$attrs.disabled ? e.disabledClass : "",
                        ],
                        attrs: { type: e.inputType },
                  ...
                  e._v(" "),
                  s("div", { staticClass: "Password__icons" }, [
                    e.badge
                      ? s(
                          "div",
                          {
                            ...
                            class: [
                              e.isSecure ? e.successClass : "",
                              !e.isSecure && e.isActive ? e.errorClass : "",
                            ],
                          },
                          [
                            e._v(
                    ...
                    e._v(" "),
                    e.toggle
                      ? s("div", { staticClass: "Password__toggle" }, [
                          s(
                            "button",
                            {
            ...
            e._v(" "),
            e.showStrengthMeter
              ? s("div", { class: [e.strengthMeterClass] }, [
                  s("div", {
                    class: [e.strengthMeterFillClass],
                    attrs: { "data-score": e.passwordStrength },
                  }),
                ])
              : e._e(),
          ]);
      ...
      e.exports = function (e, t) {
        for (var s = [], r = {}, n = 0; n < t.length; n++) {
          var o = t[n],
            ...
            d = o[2],
            u = o[3],
            l = { id: e + ":" + n, css: i, media: d, sourceMap: u };
          r[a] ? r[a].parts.push(l) : s.push((r[a] = { id: a, parts: [l] }));
        }
        return s;
      };
    },
