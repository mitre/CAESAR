      ...
      ((function (e) {
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return this.files
                        .filter(function (e) {
                          return (
                            e.status === o.UPLOADING || e.status === o.QUEUED
                          );
                        })
                        .map(function (e) {
                          return e;
                      ...
                      if (e > 0) {
                        for (
                          ...
                          if (
                            ...
                            (t =
                              e / Math.pow(this.options.filesizeBase, 4 - r)),
                              (i = o);
                            break;
                          }
                        }
                          ...
                          if (n.length > 0) {
                            for (var r = 0, o = (o = n); !(r >= o.length); ) {
                              ...
                              s.isFile
                                ...
                                : s.isDirectory &&
                                  i._addFilesFromDirectory(s, t + "/" + s.name);
                            }
                            e();
                          }
                          return null;
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        ((e.status = o.QUEUED), this.options.autoProcessQueue)
                      )
                        return setTimeout(function () {
                          ...
                          if (
                            ((n.upload.finishedChunkUpload = function (i) {
                              ...
                              for (
                                ...
                                n.upload.chunks[a].status !== o.SUCCESS &&
                                  (r = !1);
                              }
                              r &&
        ...
        var l = function (e, t, i, n, r, o, s, a, l, u) {
            var d = (function (e) {
              ...
              n.drawImage(e, 0, 0);
              for (
                var r = n.getImageData(1, 0, 1, t).data, o = 0, s = t, a = t;
                a > o;
                  ...
                  value: function (e) {
                    ...
                    for (
                      ...
                      (t =
                        ...
                        ((r = this.KEY_STR.indexOf(e.charAt(a++))) >> 4)),
                        (i =
                          ((15 & r) << 4) |
                          ((o = this.KEY_STR.indexOf(e.charAt(a++))) >> 2)),
                        (n =
                          ((3 & o) << 6) |
          ...
          [
            this.useCustomSlot
              ? t(
                  ...
                  [this._t("default", [this._v("Drop files here to upload")])],
                  2,
                )
              : this._e(),
          ],
          ...
          this.dropzone.on("success", function (t, i) {
            if ((e.$emit("vdropzone-success", t, i), e.isS3)) {
              if (e.isS3OverridesServerPropagation) {
                var n = new window.DOMParser().parseFromString(i, "text/xml")
                  .firstChild.children[0].innerHTML;
        ...
        manuallyAddFile: function (e, t) {
          ...
          if (
            ...
            this.dropzone.options.createImageThumbnails &&
              i &&
              e.size <=
                1024 * this.dropzone.options.maxThumbnailFilesize * 1024)
          ) {
            ...
            : t.then((t) => {
                t.success
                  ? ((e.s3ObjectLocation = t.message),
                    setTimeout(() => this.dropzone.processFile(e)),
                    this.$emit("vdropzone-s3-upload-success", t.message))
                  : void 0 !== t.message
