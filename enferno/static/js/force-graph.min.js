...
!(function (t, n) {
      ...
      (function (t, n) {
        ...
        if (null != e) {
          ...
          try {
            ...
            try {
              if (!s && null != e.return && ((a = e.return()), Object(a) !== a))
                return;
            } finally {
              if (l) throw i;
            }
  ...
  function O(t, n, e, r, i, o) {
    for (var a, u = 0, s = n.length, l = o.length; u < l; ++u)
      (a = n[u]) ? ((a.__data__ = o[u]), (r[u] = a)) : (e[u] = new N(t, o[u]));
    for (; u < s; ++u) (a = n[u]) && (i[u] = a);
  }
  function T(t, n, e, r, i, o, a) {
    var u,
      s,
      l,
      c = new Map(),
    ...
    for (u = 0; u < f; ++u)
      (l = a.call(t, o[u], u, o) + ""),
        (s = c.get(l))
          ...
          : (e[u] = new N(t, o[u]));
    for (u = 0; u < h; ++u) (s = n[u]) && c.get(d[u]) === s && (i[u] = s);
  }
  function j(t) {
    return t.__data__;
  }
  ...
  function X(t, n) {
    return (
      ...
      $(t).getComputedStyle(t, null).getPropertyValue(n)
    );
  }
  function Y(t) {
    return function () {
  ...
  function zt() {
    return new Mt([[document.documentElement]], kt);
  }
  function At(t) {
  ...
  Mt.prototype = zt.prototype = {
    ...
    select: function (t) {
      ...
      for (
        ...
        for (
          var o, a, u = n[i], s = u.length, l = (r[i] = new Array(s)), c = 0;
          c < s;
          ++c
        )
          (o = u[c]) &&
    ...
    selectAll: function (t) {
      ...
      for (
        ...
        for (var a, u = n[o], s = u.length, l = 0; l < s; ++l)
          (a = u[l]) && (r.push(t.call(a, a.__data__, l, u)), i.push(a));
      return new Mt(r, i);
    },
    ...
    data: function (t, n) {
      if (!arguments.length) return Array.from(this, j);
      var e = n ? T : O,
        r = this._parents,
        i = this._groups;
      ...
      for (
        ...
        var c = r[l],
          h = i[l],
          f = h.length,
          d = R(t.call(c, c && c.__data__, l, r)),
          p = d.length,
          g = (u[l] = new Array(p)),
          y = (a[l] = new Array(p)),
          v = (s[l] = new Array(f));
        e(c, h, g, y, v, d, n);
        for (var _, m, x = 0, b = 0; x < p; ++x)
          if ((_ = g[x])) {
            for (x >= b && (b = x + 1); !(m = y[b]) && ++b < p; );
            _._next = m || null;
          }
      }
    ...
    enter: function () {
      return new Mt(this._enter || this._groups.map(E), this._parents);
    },
    exit: function () {
      return new Mt(this._exit || this._groups.map(E), this._parents);
    },
    join: function (t, n, e) {
      var r = this.enter(),
        i = this,
    ...
    sort: function (t) {
      ...
      for (
        ...
        for (
          var a, u = e[o], s = u.length, l = (i[o] = new Array(s)), c = 0;
          c < s;
          ++c
        )
          (a = u[c]) && (l[c] = a);
    ...
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each(
            (null == n ? H : "function" == typeof n ? G : V)(
              t,
              n,
              null == e ? "" : e,
            ),
    ...
    property: function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? Y : "function" == typeof n ? Z : W)(t, n))
        : this.node()[t];
    },
    classed: function (t, n) {
      ...
      return this.each(("function" == typeof n ? it : n ? et : rt)(e, n));
    },
    text: function (t) {
    ...
    html: function (t) {
      return arguments.length
        ? this.each(null == t ? st : ("function" == typeof t ? ct : lt)(t))
        : this.node().innerHTML;
    },
    raise: function () {
      return this.each(ht);
    ...
    insert: function (t, n) {
      var e = "function" == typeof t ? t : v(t),
        r = null == n ? dt : "function" == typeof n ? n : m(n);
      return this.select(function () {
    ...
    on: function (t, n, e) {
      var r,
        ...
        a = o.length;
      if (!(arguments.length < 2)) {
        for (u = n ? mt : _t, r = 0; r < a; ++r) this.each(u(o[r], n, e));
        return this;
      }
    ...
    dispatch: function (t, n) {
      return this.each(("function" == typeof n ? wt : bt)(t, n));
    },
  ...
  Nt.prototype = Et.prototype = {
    ...
    on: function (t, n) {
      ...
      if (!(arguments.length < 2)) {
        ...
        for (; ++o < a; )
          if ((e = (t = i[o]).type)) r[e] = Tt(r[e], t.name, n);
          else if (null == n) for (e in r) r[e] = Tt(r[e], t.name, null);
        return this;
      }
      for (; ++o < a; )
        if ((e = (t = i[o]).type) && (e = Ot(r[e], t.name))) return e;
    },
    copy: function () {
      var t = {},
        n = this._;
  ...
  function Ut(t) {
    var n = t.document.documentElement,
      e = At(t).on("dragstart.drag", It, Rt);
    "onselectstart" in n
      ? e.on("selectstart.drag", It, Rt)
      : ((n.__noselect = n.style.MozUserSelect),
        (n.style.MozUserSelect = "none"));
  }
  function Ft(t, n) {
    var e = t.document.documentElement,
      r = At(t).on("dragstart.drag", null);
    n &&
      (r.on("click.drag", It, Rt),
      setTimeout(function () {
  ...
  var Wt = 0.7,
    ...
    en = new RegExp(`^rgb\\(${Jt},${Jt},${Jt}\\)$`),
    rn = new RegExp(`^rgba\\(${Qt},${Qt},${Qt},${Kt}\\)$`),
    on = new RegExp(`^rgba\\(${Jt},${Jt},${Jt},${Kt}\\)$`),
    an = new RegExp(`^hsl\\(${Kt},${Jt},${Jt}\\)$`),
    un = new RegExp(`^hsla\\(${Kt},${Jt},${Jt},${Kt}\\)$`),
    sn = {
      aliceblue: 15792383,
  ...
  function pn(t) {
    return (
      t instanceof Yt || (t = hn(t)),
      t ? new yn((t = t.rgb()).r, t.g, t.b, t.opacity) : new yn()
    );
  }
  function gn(t, n, e, r) {
    return 1 === arguments.length ? pn(t) : new yn(t, n, e, null == r ? 1 : r);
  }
  function yn(t, n, e, r) {
  ...
  function kn(t) {
    ...
    if ((t instanceof Yt || (t = hn(t)), !t)) return new Mn();
  ...
  Gt(Yt, hn, {
    ...
    Gt(
      ...
      Xt(Yt, {
        ...
        clamp() {
          return new yn(xn(this.r), xn(this.g), xn(this.b), mn(this.opacity));
        },
        displayable() {
          return (
            -0.5 <= this.r &&
        ...
        formatHex: vn,
        formatHex8: function () {
          return `#${bn(this.r)}${bn(this.g)}${bn(this.b)}${bn(255 * (isNaN(this.opacity) ? 1 : this.opacity))}`;
        },
        formatRgb: _n,
        toString: _n,
      }),
    ...
    Gt(
      ...
      Xt(Yt, {
        ...
        clamp() {
          return new Mn(zn(this.h), An(this.s), An(this.l), mn(this.opacity));
        },
        displayable() {
          return (
        ...
        formatHsl() {
          const t = mn(this.opacity);
          return `${1 === t ? "hsl(" : "hsla("}${zn(this.h)}, ${100 * An(this.s)}%, ${100 * An(this.l)}%${1 === t ? ")" : `, ${t})`}`;
        },
      }),
    );
  var Cn = (t) => () => t;
  ...
  var Tn = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
    jn = new RegExp(Tn.source, "g");
  function Rn(t, n) {
    var e,
      r,
      i,
      o = (Tn.lastIndex = jn.lastIndex = 0),
      a = -1,
      u = [],
      s = [];
    for (t += "", n += ""; (e = Tn.exec(t)) && (r = jn.exec(n)); )
      (i = r.index) > o &&
      ...
      return (
        ...
        (function (t, r, i, o, a, u) {
          if (t !== i || r !== o) {
            ...
            u.push({ i: s - 4, x: On(t, i) }, { i: s - 2, x: On(r, o) });
        ...
        (function (t, n, e, r, o, a) {
          if (t !== e || n !== r) {
            ...
            a.push({ i: u - 4, x: On(t, e) }, { i: u - 2, x: On(n, r) });
          } else
  ...
  var qn = Ln(
      function (t) {
        ...
        return n.isIdentity ? Un : Fn(n.a, n.b, n.c, n.d, n.e, n.f);
      },
      "px, ",
      "px)",
      "deg)",
      ...
      function (t) {
        return null == t
          ...
          : (Dn ||
            ...
            Dn.setAttribute("transform", t),
            (t = Dn.transform.baseVal.consolidate())
              ? Fn((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f)
              : Un);
      },
      ", ",
      ")",
    ...
    Gn = (function t(n, e, r) {
      function i(t, i) {
        ...
        if (g < 1e-12)
          (a = Math.log(f / l) / n),
            (o = function (t) {
              return [u + t * d, s + t * p, l * Math.exp(n * t * a)];
            });
        else {
          var y = Math.sqrt(g),
            v = (f * f - l * l + r * g) / (2 * l * e * y),
            _ = (f * f - l * l - r * g) / (2 * f * e * y),
          ...
          (a = (x - m) / n),
            (o = function (t) {
              ...
              return [u + o * d, s + o * p, (l * i) / $n(n * r + m)];
            });
        }
  ...
  function oe() {
    (Qn = (Zn = Jn.now()) + Kn), (Xn = Yn = 0);
    try {
      !(function () {
        ne(), ++Xn;
        for (var t, n = Hn; n; )
          (t = Qn - n._time) >= 0 && n._call.call(void 0, t), (n = n._next);
        --Xn;
      })();
    } finally {
      (Xn = 0),
  ...
  function ue(t) {
    Xn ||
      ...
      t - Qn > 24
        ? (t < 1 / 0 && (Yn = setTimeout(oe, t - Jn.now() - Kn)),
          Wn && (Wn = clearInterval(Wn)))
        : (Wn || ((Zn = Jn.now()), (Wn = setInterval(ae, 1e3))),
          (Xn = 1),
          te(oe)));
  }
  function se(t, n, e) {
  ...
  re.prototype = ie.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? ne() : +e) + (null == n ? 0 : +n)),
        this._next ||
          Vn === this ||
          (Vn ? (Vn._next = this) : (Hn = this), (Vn = this)),
        (this._call = t),
        (this._time = e),
        ue();
    },
  ...
  var le = Et("start", "end", "cancel", "interrupt"),
    ce = [];
    ...
    !(function (t, n, e) {
      ...
      function a(o) {
        ...
        if (
          ...
          for (
            e.state = 3, r = new Array((h = e.tween.length)), l = 0, c = -1;
            l < h;
            ++l
          )
            (f = e.tween[l].value.call(t, t.__data__, e.index, e.group)) &&
              (r[++c] = f);
          r.length = c + 1;
        }
      }
  ...
  function Oe(t, n) {
    return function () {
      de(this, t).duration = +n.apply(this, arguments);
    };
  }
  function Te(t, n) {
    return (
  ...
  var De = zt.prototype.constructor;
  function Ie(t) {
    return function () {
      this.style.removeProperty(t);
    };
  ...
  $e.prototype = {
    ...
    select: function (t) {
      ...
      for (
        ...
        for (
          var u, s, l = r[a], c = l.length, h = (o[a] = new Array(c)), f = 0;
          f < c;
          ++f
        )
          (u = l[f]) &&
            (s = t.call(u, u.__data__, f, l)) &&
            ("__data__" in u && (s.__data__ = u.__data__),
            (h[f] = s),
            he(h[f], n, e, f, h, pe(u, e)));
    ...
    selectAll: function (t) {
      ...
      for (
        ...
        for (var s, l = r[u], c = l.length, h = 0; h < c; ++h)
          if ((s = l[h])) {
            for (
              var f,
                d = t.call(s, s.__data__, h, l),
                p = pe(s, e),
                g = 0,
                y = d.length;
              g < y;
    ...
    attr: function (t, n) {
      ...
      return this.attrTween(
        t,
        "function" == typeof n
          ? (e.local ? ze : Me)(e, r, _e(this, "attr." + t, n))
          : null == n
            ? (e.local ? be : xe)(e)
            : (e.local ? ke : we)(e, r, n),
      );
    ...
    attrTween: function (t, n) {
      ...
      if ("function" != typeof n) throw new Error();
      var r = p(t);
      return this.tween(e, (r.local ? Ce : Ee)(r, n));
    },
    style: function (t, n, e) {
      var r = "transform" == (t += "") ? qn : me;
      return null == n
        ? this.styleTween(
            t,
            (function (t, n) {
          ...
          ? this.styleTween(
              ...
              (function (t, n, e) {
                ...
                return function () {
                  ...
                  return (
                    null == u &&
                      (this.style.removeProperty(t), (s = u = X(this, t))),
                    a === s
                      ? null
                      : a === r && s === i
                        ? o
              ...
              (function (t, n) {
                ...
                return function () {
                  var s = de(this, t),
                    l = s.on,
                    c = null == s.value[a] ? o || (o = Ie(n)) : void 0;
                  (l === e && i === c) || (r = (e = l).copy()).on(u, (i = c)),
                    (s.on = r);
                };
              })(this._id, t),
            )
    ...
    styleTween: function (t, n, e) {
      ...
      if ("function" != typeof n) throw new Error();
      return this.tween(r, Fe(t, n, null == e ? "" : e));
    },
    text: function (t) {
      return this.tween(
        "text",
    ...
    tween: function (t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = pe(this.node(), e).tween, o = 0, a = i.length;
          o < a;
          ++o
        )
      ...
      return this.each((null == n ? ye : ve)(e, t, n));
    },
    delay: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(("function" == typeof t ? Ne : Pe)(n, t))
        : pe(this.node(), n).delay;
    },
    duration: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(("function" == typeof t ? Oe : Te)(n, t))
        : pe(this.node(), n).duration;
    },
    ease: function (t) {
      var n = this._id;
      return arguments.length ? this.each(je(n, t)) : pe(this.node(), n).ease;
    },
  ...
  (zt.prototype.interrupt = function (t) {
    ...
    (zt.prototype.transition = function (t) {
      ...
      t instanceof $e
        ? ((n = t._id), (t = t._name))
        : ((n = He()), ((e = Ge).time = ne()), (t = null == t ? null : t + ""));
      for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
        for (var a, u = r[o], s = u.length, l = 0; l < s; ++l)
          (a = u[l]) && he(a, t, n, l, u, e || Xe(a, n));
      return new $e(r, this._parents, t, n);
    });
  var Ye = (t) => () => t;
  function We(t, { sourceEvent: n, target: e, transform: r, dispatch: i }) {
    Object.defineProperties(this, {
      type: { value: t, enumerable: !0, configurable: !0 },
      sourceEvent: { value: n, enumerable: !0, configurable: !0 },
  ...
  Ze.prototype = {
    constructor: Ze,
    scale: function (t) {
      return 1 === t ? this : new Ze(this.k * t, this.x, this.y);
    },
    translate: function (t, n) {
      return (0 === t) & (0 === n)
        ? this
        : new Ze(this.k, this.x + this.k * t, this.y + this.k * n);
    },
    apply: function (t) {
  ...
  var Qe = new Ze(1, 0, 0);
  function Ke(t) {
    for (; !t.__zoom; ) if (!(t = t.parentNode)) return Qe;
    return t.__zoom;
  }
  function Je(t) {
    t.stopImmediatePropagation();
  ...
  function ur() {
    ...
    function _(t, n, e) {
      var r = n[0] - e[0] * t.k,
        i = n[1] - e[1] * t.k;
      return r === t.x && i === t.y ? t : new Ze(t.k, r, i);
    }
    function m(t) {
      ...
      t.on("start.zoom", function () {
        ...
        .tween("zoom", function () {
          var t = this,
            ...
            a = b(t, o).event(r),
            u = i.apply(t, o),
            s = null == e ? m(u) : "function" == typeof e ? e.apply(t, o) : e,
            l = Math.max(u[1][0] - u[0][0], u[1][1] - u[0][1]),
            c = t.__zoom,
            f = "function" == typeof n ? n.apply(t, o) : n,
            d = h(c.invert(s).concat(l / c.k), f.invert(s).concat(l / f.k));
          return function (t) {
            if (1 === t) t = f;
            else {
              var n = d(t),
                e = l / n[2];
              t = new Ze(e, s[0] - n[0] * e, s[1] - n[1] * e);
            }
            a.zoom(null, t);
          };
        });
    ...
    function k(t, ...n) {
      if (r.apply(this, arguments)) {
        ...
        tr(t),
          (e.wheel = setTimeout(h, 150)),
          e.zoom("mouse", o(_(v(i, u), e.mouse[0], e.mouse[1]), e.extent, l));
      }
      function h() {
        (e.wheel = null), e.end();
      }
    ...
    function M(t, ...n) {
      if (!e && r.apply(this, arguments)) {
        var i = t.currentTarget,
          ...
          u = At(t.view).on("mousemove.zoom", f, !0).on("mouseup.zoom", d, !0),
          s = St(t, i),
          c = t.clientX,
          h = t.clientY;
        Ut(t.view),
      ...
      function f(t) {
        ...
        a.event(t).zoom(
          "mouse",
          o(_(a.that.__zoom, (a.mouse[0] = St(t, i)), a.mouse[1]), a.extent, l),
        );
      }
      function d(t) {
    ...
    function z(t, ...n) {
      if (r.apply(this, arguments)) {
        var e = this.__zoom,
          a = St(t.changedTouches ? t.changedTouches[0] : t, this),
          u = e.invert(a),
          s = e.k * (t.shiftKey ? 0.5 : 2),
          h = o(_(v(e, s), a, u), i.apply(this, n), l);
        tr(t),
          c > 0
            ? At(this).transition().duration(c).call(x, h, a, t)
            : At(this).call(y.transform, h, a, t);
      }
    }
    function A(e, ...i) {
      if (r.apply(this, arguments)) {
    ...
    function S(t, ...n) {
      if (this.__zooming) {
        ...
        if (((r = u.that.__zoom), u.touch1)) {
          ...
          (r = v(r, Math.sqrt(g / y))),
            (i = [(h[0] + d[0]) / 2, (h[1] + d[1]) / 2]),
            (a = [(f[0] + p[0]) / 2, (f[1] + p[1]) / 2]);
        } else {
          if (!u.touch0) return;
          (i = u.touch0[0]), (a = u.touch0[1]);
        }
        u.zoom("touch", o(_(r, i, a), u.extent, l));
      }
    }
    function C(t, ...r) {
      if (this.__zooming) {
        ...
        if (
          ...
          (a.end(),
          2 === a.taps &&
            ((o = St(o, this)), Math.hypot(n[0] - o[0], n[1] - o[1]) < g))
        ) {
          var l = At(this).on("dblclick.zoom");
    ...
    return (
      ...
      (y.wheelDelta = function (t) {
        return arguments.length
          ? ((a = "function" == typeof t ? t : Ye(+t)), y)
          : a;
      }),
      (y.filter = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : Ye(!!t)), y)
          : r;
      }),
      (y.touchable = function (t) {
        return arguments.length
          ? ((u = "function" == typeof t ? t : Ye(!!t)), y)
          : u;
      }),
      (y.extent = function (t) {
        return arguments.length
  ...
  function lr({ _intern: t, _key: n }, e) {
    const r = n(e);
  ...
  var dr =
    ...
    _r = /^0o[0-7]+$/i,
    mr = parseInt,
    xr = "object" == typeof dr && dr && dr.Object === Object && dr,
    br = "object" == typeof self && self && self.Object === Object && self,
    wr = xr || br || Function("return this")(),
  ...
  function Sr(t, n, e) {
    var r,
      ...
      h = !1,
      f = !0;
    if ("function" != typeof t) throw new TypeError(pr);
    function d(n) {
      var e = r,
        o = i;
    ...
    function p(t) {
      return (l = t), (u = setTimeout(y, n)), c ? d(t) : a;
    }
    function g(t) {
      var e = t - s;
    ...
    function y() {
      ...
      u = setTimeout(
        ...
        (function (t) {
          var e = n - (t - s);
          return h ? zr(e, o - (t - l)) : e;
        })(t),
      );
    }
    function v(t) {
      return (u = void 0), f && r ? d(t) : ((r = i = void 0), a);
    }
    function _() {
      var t = Ar(),
        e = g(t);
      if (((r = arguments), (i = this), (s = t), e)) {
        if (void 0 === u) return p(s);
        if (h) return (u = setTimeout(y, n)), d(s);
      }
  ...
  function Er(t) {
    ...
    t = t.replace(gr, "");
    var e = vr.test(t);
    return e || _r.test(t) ? mr(t.slice(2), e ? 2 : 8) : yr.test(t) ? NaN : +t;
  }
  var Nr = function (t, n, e) {
      var r = !0,
        i = !0;
      if ("function" != typeof t) throw new TypeError(pr);
      return (
        ...
        Sr(t, n, { leading: r, maxWait: n, trailing: i })
      );
    },
    Pr = {
      Linear: {
      ...
      Bounce: {
        ...
        InOut: function (t) {
          return t < 0.5
            ? 0.5 * Pr.Bounce.In(2 * t)
            : 0.5 * Pr.Bounce.Out(2 * t - 1) + 0.5;
        },
      },
    },
    Or =
          ...
          for (; e.length > 0; ) {
            ...
            for (var r = 0; r < e.length; r++) {
              var i = this._tweens[e[r]],
                o = !n;
              i && !1 === i.update(t, o) && !n && delete this._tweens[e[r]];
            }
      ...
      Bezier: function (t, n) {
        for (
          var e = 0,
            r = t.length - 1,
            i = Math.pow,
            o = jr.Utils.Bernstein,
            a = 0;
          a <= r;
          a++
        )
          e += i(1 - n, r - a) * i(n, a) * t[a] * o(r, a);
        return e;
      },
    ...
    Ir = (function () {
      function t(t, n) {
        void 0 === n && (n = Dr),
          ...
          (this._delayTime = 0),
          (this._startTime = 0),
          (this._easingFunction = Pr.Linear.None),
          (this._interpolationFunction = jr.Linear),
          (this._chainedTweens = []),
      ...
      return (
          ...
          for (var i in e) {
            ...
            if ("undefined" !== u && "function" !== u) {
              ...
              if (("object" !== u && !a) || !o || s)
                void 0 === n[i] && (n[i] = o),
                  a || (n[i] *= 1),
                  (r[i] = s ? e[i].slice().reverse() : n[i] || 0);
              else {
                for (var c in ((n[i] = a ? [] : {}), o)) n[i][c] = o[c];
                (r[i] = a ? [] : {}),
                  this._setupProperties(o, n[i], e[i], r[i]);
              }
            }
          }
        }),
        ...
        (t.prototype._swapEndStartRepeatValues = function (t) {
          ...
          (this._valuesStartRepeat[t] =
            "string" == typeof e
              ? this._valuesStartRepeat[t] + parseFloat(e)
              : this._valuesEnd[t]),
            (this._valuesEnd[t] = n);
        }),
        t
    ...
    Ur = Rr.nextId,
    Fr = Dr,
    Lr = Fr.getAll.bind(Fr),
    qr = Fr.removeAll.bind(Fr),
    Br = Fr.add.bind(Fr),
    $r = Fr.remove.bind(Fr),
    Hr = Fr.update.bind(Fr),
    Vr = {
      Easing: Pr,
      Group: Tr,
      Interpolation: jr,
  ...
  function Zr(t, n) {
    return (
      ...
      (function (t, n) {
        if (!t) return;
        if ("string" == typeof t) return Qr(t, n);
        var e = Object.prototype.toString.call(t).slice(8, -1);
        "Object" === e && t.constructor && (e = t.constructor.name);
  ...
  const ni = /^\s+/,
    ei = /\s+$/;
  function ri(t, n) {
    if (((n = n || {}), (t = t || "") instanceof ri)) return t;
    if (!(this instanceof ri)) return new ri(t, n);
    var e = (function (t) {
      var n = { r: 0, g: 0, b: 0 },
        e = 1,
        r = null,
      ...
      "string" == typeof t &&
        (t = (function (t) {
          t = t.replace(ni, "").replace(ei, "").toLowerCase();
          var n,
            e = !1;
          if (xi[t]) (t = xi[t]), (e = !0);
          else if ("transparent" == t)
            return { r: 0, g: 0, b: 0, a: 0, format: "name" };
          if ((n = Ti.rgb.exec(t))) return { r: n[1], g: n[2], b: n[3] };
          if ((n = Ti.rgba.exec(t)))
            return { r: n[1], g: n[2], b: n[3], a: n[4] };
          if ((n = Ti.hsl.exec(t))) return { h: n[1], s: n[2], l: n[3] };
          if ((n = Ti.hsla.exec(t)))
            return { h: n[1], s: n[2], l: n[3], a: n[4] };
          if ((n = Ti.hsv.exec(t))) return { h: n[1], s: n[2], v: n[3] };
          if ((n = Ti.hsva.exec(t)))
      ...
      "object" == typeof t &&
        (ji(t.r) && ji(t.g) && ji(t.b)
          ...
          : ji(t.h) && ji(t.s) && ji(t.v)
            ? ((r = Si(t.s)),
              (i = Si(t.v)),
              (n = (function (t, n, e) {
                (t = 6 * ki(t, 360)), (n = ki(n, 100)), (e = ki(e, 100));
                var r = Math.floor(t),
                  i = t - r,
                  o = e * (1 - n),
                  a = e * (1 - i * n),
                  ...
                  c = [u, e, e, a, o, o][s],
                  h = [o, o, u, e, e, a][s];
                return { r: 255 * l, g: 255 * c, b: 255 * h };
              })(t.h, r, i)),
              (a = !0),
              (u = "hsv"))
            : ji(t.h) &&
  ...
  function ii(t, n, e) {
    (t = ki(t, 255)), (n = ki(n, 255)), (e = ki(e, 255));
    var r,
      i,
      o = Math.max(t, n, e),
      a = Math.min(t, n, e),
    ...
    if (o == a) r = i = 0;
      ...
      var s = o - a;
      switch (((i = u > 0.5 ? s / (2 - o - a) : s / (o + a)), o)) {
        case t:
          r = (n - e) / s + (n < e ? 6 : 0);
          break;
        case n:
  ...
  function si(t, n) {
    n = 0 === n ? 0 : n || 10;
    var e = ri(t).toHsl();
    return (e.s -= n / 100), (e.s = Mi(e.s)), ri(e);
  }
  function li(t, n) {
    n = 0 === n ? 0 : n || 10;
    var e = ri(t).toHsl();
  ...
  function ci(t) {
    return ri(t).desaturate(100);
  }
  function hi(t, n) {
    n = 0 === n ? 0 : n || 10;
    var e = ri(t).toHsl();
    return (e.l += n / 100), (e.l = Mi(e.l)), ri(e);
  }
  function fi(t, n) {
    n = 0 === n ? 0 : n || 10;
    var e = ri(t).toRgb();
  ...
  function pi(t, n) {
    var e = ri(t).toHsl(),
      r = (e.h + n) % 360;
    return (e.h = r < 0 ? 360 + r : r), ri(e);
  }
  function gi(t) {
    var n = ri(t).toHsl();
    return (n.h = (n.h + 180) % 360), ri(n);
  }
  function yi(t, n) {
    if (isNaN(n) || n <= 0)
      throw new Error("Argument to polyad must be a positive number");
    for (var e = ri(t).toHsl(), r = [ri(t)], i = 360 / n, o = 1; o < n; o++)
      r.push(ri({ h: (e.h + o * i) % 360, s: e.s, l: e.l }));
    return r;
  }
  function vi(t) {
    var n = ri(t).toHsl(),
    ...
    return [
      ri(t),
      ri({ h: (e + 72) % 360, s: n.s, l: n.l }),
      ri({ h: (e + 216) % 360, s: n.s, l: n.l }),
    ];
  }
  function _i(t, n, e) {
    (n = n || 6), (e = e || 30);
    ...
    for (r.h = (r.h - ((i * n) >> 1) + 720) % 360; --n; )
      (r.h = (r.h + i) % 360), o.push(ri(r));
    return o;
  }
  function mi(t, n) {
    n = n || 6;
    for (
      var e = ri(t).toHsv(), r = e.h, i = e.s, o = e.v, a = [], u = 1 / n;
      n--;

    )
      a.push(ri({ h: r, s: i, v: o })), (o = (o + u) % 1);
    return a;
  }
  (ri.prototype = {
    isDark: function () {
    ...
    toHsv: function () {
      var t = oi(this._r, this._g, this._b);
    ...
    toHsl: function () {
      var t = ii(this._r, this._g, this._b);
    ...
    toHex: function (t) {
      return ai(this._r, this._g, this._b, t);
    },
    ...
    toPercentageRgb: function () {
      return {
        r: Math.round(100 * ki(this._r, 255)) + "%",
        g: Math.round(100 * ki(this._g, 255)) + "%",
        b: Math.round(100 * ki(this._b, 255)) + "%",
        a: this._a,
      };
    },
    toPercentageRgbString: function () {
      return 1 == this._a
        ? "rgb(" +
            Math.round(100 * ki(this._r, 255)) +
            "%, " +
            Math.round(100 * ki(this._g, 255)) +
            "%, " +
            Math.round(100 * ki(this._b, 255)) +
            "%)"
        : "rgba(" +
            Math.round(100 * ki(this._r, 255)) +
            "%, " +
    ...
    toName: function () {
      return 0 === this._a
        ? "transparent"
        : !(this._a < 1) && (bi[ai(this._r, this._g, this._b, !0)] || !1);
    },
    toFilter: function (t) {
      var n = "#" + ui(this._r, this._g, this._b, this._a),
        e = n,
        r = this._gradientType ? "GradientType = 1, " : "";
      if (t) {
        var i = ri(t);
        e = "#" + ui(i._r, i._g, i._b, i._a);
      }
      return (
    ...
    brighten: function () {
      return this._applyModification(fi, arguments);
    },
    darken: function () {
      return this._applyModification(di, arguments);
    },
    desaturate: function () {
    ...
    greyscale: function () {
      return this._applyModification(ci, arguments);
    },
    spin: function () {
    ...
    analogous: function () {
      return this._applyCombination(_i, arguments);
    },
    complement: function () {
      return this._applyCombination(gi, arguments);
    },
    monochromatic: function () {
      return this._applyCombination(mi, arguments);
    },
    splitcomplement: function () {
      return this._applyCombination(vi, arguments);
    },
    triad: function () {
      return this._applyCombination(yi, [3]);
    },
    tetrad: function () {
      return this._applyCombination(yi, [4]);
    },
  }),
    (ri.fromRatio = function (t, n) {
      if ("object" == typeof t) {
        var e = {};
        for (var r in t)
          t.hasOwnProperty(r) && (e[r] = "a" === r ? t[r] : Si(t[r]));
        t = e;
      }
      return ri(t, n);
    }),
    (ri.equals = function (t, n) {
      return !(!t || !n) && ri(t).toRgbString() == ri(n).toRgbString();
    }),
    (ri.random = function () {
      return ri.fromRatio({
        r: Math.random(),
    ...
    (ri.readability = function (t, n) {
      var e = ri(t),
        r = ri(n);
      return (
        (Math.max(e.getLuminance(), r.getLuminance()) + 0.05) /
        (Math.min(e.getLuminance(), r.getLuminance()) + 0.05)
      );
    }),
    (ri.isReadable = function (t, n, e) {
      var r,
        i,
        o = ri.readability(t, n);
      switch (
        ((i = !1),
        (r = (function (t) {
          var n, e;
    ...
    (ri.mostReadable = function (t, n, e) {
      var r,
        i,
        o,
        a,
      ...
      for (var l = 0; l < n.length; l++)
        (r = ri.readability(t, n[l])) > s && ((s = r), (u = ri(n[l])));
      return ri.isReadable(t, u, { level: o, size: a }) || !i
        ? u
        : ((e.includeFallbackColors = !1),
          ri.mostReadable(t, ["#fff", "#000"], e));
    });
  var xi = (ri.names = {
      aliceblue: "f0f8ff",
      antiquewhite: "faebd7",
  ...
  function ki(t, n) {
    ...
    return (
      (t = Math.min(n, Math.max(0, parseFloat(t)))),
      e && (t = parseInt(t * n, 10) / 100),
      Math.abs(t - n) < 1e-6 ? 1 : (t % n) / parseFloat(n)
    );
  }
  function Mi(t) {
  ...
  function Ii(t) {
    return (
      ...
      (function (t, n) {
        if (!t) return;
        if ("string" == typeof t) return Ui(t, n);
        var e = Object.prototype.toString.call(t).slice(8, -1);
        "Object" === e && t.constructor && (e = t.constructor.name);
        if ("Map" === e || "Set" === e) return Array.from(t);
        if (
        ...
        (e = [
          {
            ...
            value: function (t) {
              ...
              var n,
                ...
                r = Li(e, this.csBits),
                i =
                  ((n = e + (r << (24 - this.csBits))),
                  "#".concat(
                    Math.min(n, Math.pow(2, 24)).toString(16).padStart(6, "0"),
                  ));
                ...
                o =
                  "string" == typeof t
                    ? ((n = ri(t).toRgb()),
                      ...
                      (i = n.b),
                      Fi(e, r, i))
                    : Fi.apply(void 0, Ii(t));
              if (!o) return null;
              var a = o & (Math.pow(2, 24 - this.csBits) - 1),
                u = (o >> (24 - this.csBits)) & (Math.pow(2, this.csBits) - 1);
              return Li(a, this.csBits) !== u || a >= this.registry.length
                ? null
                : this.registry[a];
            },
          },
  ...
  function Bi(t, n, e) {
    ...
    function o() {
      var o,
        ...
        c = 0;
      for (o = 0; o < u; ++o)
        (s += (a = r[o]).x || 0), (l += a.y || 0), (c += a.z || 0);
      for (
        s = (s / u - t) * i, l = (l / u - n) * i, c = (c / u - e) * i, o = 0;
        o < u;
        ++o
      )
        (a = r[o]), s && (a.x -= s), l && (a.y -= l), c && (a.z -= c);
    }
    return (
      null == t && (t = 0),
      null == n && (n = 0),
  ...
  function $i(t, n, e) {
    ...
    for (; l.length; )
      if (
        ...
        return (r[u] = c), t;
    if (n === (o = +t._x.call(null, l.data)))
      return (c.next = l), r ? (r[u] = c) : (t._root = c), t;
    do {
      (r = r ? (r[u] = new Array(2)) : (t._root = new Array(2))),
        (a = n >= (i = (h + f) / 2)) ? (h = i) : (f = i);
    } while ((u = +a) == (s = +(o >= i)));
  ...
  function Gi(t, n) {
    var e = new Xi(null == n ? Vi : n, NaN, NaN);
  ...
  var Wi = (Gi.prototype = Xi.prototype);
  function Zi(t, n, e, r) {
  ...
  function to(t, n, e) {
    var r = new no(null == n ? Ki : n, null == e ? Ji : e, NaN, NaN, NaN, NaN);
  ...
  (Wi.copy = function () {
    var t,
      n,
      e = new Xi(this._x, this._x0, this._x1),
      r = this._root;
    if (!r) return e;
    if (!r.length) return (e._root = Yi(r)), e;
    for (t = [{ source: r, target: (e._root = new Array(2)) }]; (r = t.pop()); )
      for (var i = 0; i < 2; ++i)
        (n = r.source[i]) &&
          (n.length
            ? t.push({ source: n, target: (r.target[i] = new Array(2)) })
            : (r.target[i] = Yi(n)));
    return e;
  }),
    (Wi.add = function (t) {
      var n = +this._x.call(null, t);
      return $i(this.cover(n), n, t);
    }),
    (Wi.addAll = function (t) {
      var n,
        ...
        a = -1 / 0;
      for (n = 0; n < r; ++n)
        isNaN((e = +this._x.call(null, t[n]))) ||
          ((i[n] = e), e < o && (o = e), e > a && (a = e));
      if (o > a) return this;
      for (this.cover(o).cover(a), n = 0; n < r; ++n) $i(this, i[n], t[n]);
      return this;
    }),
    (Wi.cover = function (t) {
      ...
      if (isNaN(n)) e = (n = Math.floor(t)) + 1;
        ...
        for (var r, i, o = e - n || 1, a = this._root; n > t || t >= e; )
          switch (
            ((i = +(t < n)), ((r = new Array(2))[i] = a), (a = r), (o *= 2), i)
          ) {
            case 0:
              e = n + o;
              break;
    ...
    (Wi.find = function (t, n) {
      var e,
        ...
        c = this._root;
      for (
        c && l.push(new Hi(c, u, s)),
          null == n ? (n = 1 / 0) : ((u = t - n), (s = t + n));
        (o = l.pop());
        ...
        if (!(!(c = o.node) || (r = o.x0) > s || (i = o.x1) < u))
          if (c.length) {
            var h = (r + i) / 2;
            l.push(new Hi(c[1], h, i), new Hi(c[0], r, h)),
              (a = +(t >= h)) &&
                ((o = l[l.length - 1]),
    ...
    (Wi.visit = function (t) {
      var n,
        ...
        o = [],
        a = this._root;
      for (a && o.push(new Hi(a, this._x0, this._x1)); (n = o.pop()); )
        if (!t((a = n.node), (r = n.x0), (i = n.x1)) && a.length) {
          var u = (r + i) / 2;
          (e = a[1]) && o.push(new Hi(e, u, i)),
            (e = a[0]) && o.push(new Hi(e, r, u));
        }
      return this;
    }),
    (Wi.visitAfter = function (t) {
      var n,
        ...
        r = [];
      for (
        this._root && e.push(new Hi(this._root, this._x0, this._x1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            u = n.x1,
            s = (a + u) / 2;
          (o = i[0]) && e.push(new Hi(o, a, s)),
            (o = i[1]) && e.push(new Hi(o, s, u));
        }
        r.push(n);
      }
  ...
  var ro = (to.prototype = no.prototype);
  function io(t, n, e, r, i) {
    ...
    for (; v.length; )
      if (
        ...
        return (o[g] = _), t;
    if (
      ((l = +t._x.call(null, v.data)),
      (c = +t._y.call(null, v.data)),
      (h = +t._z.call(null, v.data)),
      n === l && e === c && r === h)
    )
      return (_.next = v), o ? (o[g] = _) : (t._root = _), t;
    do {
      (o = o ? (o[g] = new Array(8)) : (t._root = new Array(8))),
        (f = n >= (a = (m + w) / 2)) ? (m = a) : (w = a),
        (d = e >= (u = (x + k) / 2)) ? (x = u) : (k = u),
        (p = r >= (s = (b + M) / 2)) ? (b = s) : (M = s);
    } while (
  ...
  (ro.copy = function () {
    var t,
      n,
      e = new no(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
      r = this._root;
    if (!r) return e;
    if (!r.length) return (e._root = eo(r)), e;
    ...
    (ro.add = function (t) {
      ...
      return Zi(this.cover(n, e), n, e, t);
    }),
    (ro.addAll = function (t) {
      var n,
        e,
        r,
        i,
      ...
      for (this.cover(s, l).cover(c, h), e = 0; e < o; ++e)
        Zi(this, a[e], u[e], t[e]);
      return this;
    }),
    (ro.cover = function (t, n) {
    ...
    (ro.find = function (t, n, e) {
      var r,
        ...
        g = this._root;
      for (
        g && p.push(new Qi(g, c, h, f, d)),
          null == e
            ? (e = 1 / 0)
            : ((c = t - e), (h = n - e), (f = t + e), (d = n + e), (e *= e));
        (s = p.pop());
        ...
        if (
          ...
          if (g.length) {
            ...
            if (x < e) {
              var b = Math.sqrt((e = x));
              (c = t - b), (h = n - b), (f = t + b), (d = n + b), (r = g.data);
            }
          }
      return r;
    }),
    (ro.remove = function (t) {
      if (
          ...
          : n
            ? (i ? (n[h] = i) : delete n[h],
              (d = n[0] || n[1] || n[2] || n[3]) &&
                d === (n[3] || n[2] || n[1] || n[0]) &&
                !d.length &&
                (e ? (e[f] = d) : (this._root = d)),
              this)
            : ((this._root = i), this)
      );
    }),
    (ro.removeAll = function (t) {
      for (var n = 0, e = t.length; n < e; ++n) this.remove(t[n]);
      return this;
    }),
    (ro.root = function () {
    ...
    (ro.visit = function (t) {
      var n,
        ...
        s = this._root;
      for (
        s && u.push(new Qi(s, this._x0, this._y0, this._x1, this._y1));
        (n = u.pop());

      )
        if (
          !t((s = n.node), (r = n.x0), (i = n.y0), (o = n.x1), (a = n.y1)) &&
          s.length
        ) {
          var l = (r + o) / 2,
            c = (i + a) / 2;
          (e = s[3]) && u.push(new Qi(e, l, c, o, a)),
            (e = s[2]) && u.push(new Qi(e, r, c, l, a)),
            (e = s[1]) && u.push(new Qi(e, l, i, o, c)),
            (e = s[0]) && u.push(new Qi(e, r, i, l, c));
        }
      return this;
    }),
    (ro.visitAfter = function (t) {
      var n,
        e = [],
        r = [];
      for (
        this._root &&
        e.push(new Qi(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            c = (a + s) / 2,
            h = (u + l) / 2;
          (o = i[0]) && e.push(new Qi(o, a, u, c, h)),
            (o = i[1]) && e.push(new Qi(o, c, u, s, h)),
            (o = i[2]) && e.push(new Qi(o, a, h, c, l)),
            (o = i[3]) && e.push(new Qi(o, c, h, s, l));
        }
        r.push(n);
      }
  ...
  var fo = (lo.prototype = co.prototype);
  function po(t) {
    return function () {
      return t;
    };
  ...
  function _o(t) {
    var n,
      ...
      h = 1;
    function f(r) {
      for (var o = 0, s = t.length; o < h; ++o)
        for (var l, c, f, d, p, g = 0, y = 0, v = 0, _ = 0; g < s; ++g)
          (c = (l = t[g]).source),
            (y = (f = l.target).x + f.vx - c.x - c.vx || go(u)),
            i > 1 && (v = f.y + f.vy - c.y - c.vy || go(u)),
            i > 2 && (_ = f.z + f.vz - c.z - c.vz || go(u)),
            (y *= d =
              (((d = Math.sqrt(y * y + v * v + _ * _)) - e[g]) / d) * r * n[g]),
            (v *= d),
            (_ *= d),
            (f.vx -= y * (p = a[g])),
            i > 1 && (f.vy -= v * p),
    ...
    function d() {
      if (r) {
        var i,
          ...
          l = r.length,
          c = t.length,
          h = new Map(r.map((t, n) => [s(t, n, r), t]));
        for (i = 0, o = new Array(l); i < c; ++i)
          ((u = t[i]).index = i),
            "object" != typeof u.source && (u.source = vo(h, u.source)),
            "object" != typeof u.target && (u.target = vo(h, u.target)),
            (o[u.source.index] = (o[u.source.index] || 0) + 1),
            (o[u.target.index] = (o[u.target.index] || 0) + 1);
        for (i = 0, a = new Array(c); i < c; ++i)
          (u = t[i]),
            (a[i] =
              o[u.source.index] / (o[u.source.index] + o[u.target.index]));
        (n = new Array(c)), p(), (e = new Array(c)), g();
      }
    }
    function p() {
    ...
    return (
      ...
      (f.initialize = function (t, ...n) {
        (r = t),
          (u = n.find((t) => "function" == typeof t) || Math.random),
          (i = n.find((t) => [1, 2, 3].includes(t)) || 2),
          d();
      }),
      (f.links = function (n) {
        return arguments.length ? ((t = n), d(), f) : t;
      }),
      (f.id = function (t) {
      ...
      (f.strength = function (t) {
        return arguments.length
          ? ((l = "function" == typeof t ? t : po(+t)), p(), f)
          : l;
      }),
      (f.distance = function (t) {
        return arguments.length
          ? ((c = "function" == typeof t ? t : po(+t)), g(), f)
          : c;
      }),
      f
    );
  ...
  (fo.copy = function () {
    var t,
      ...
      r = this._root;
    if (!r) return e;
    if (!r.length) return (e._root = ho(r)), e;
    for (t = [{ source: r, target: (e._root = new Array(8)) }]; (r = t.pop()); )
      for (var i = 0; i < 8; ++i)
        (n = r.source[i]) &&
          (n.length
            ? t.push({ source: n, target: (r.target[i] = new Array(8)) })
            : (r.target[i] = ho(n)));
    return e;
  }),
    (fo.add = function (t) {
      ...
      return io(this.cover(n, e, r), n, e, r, t);
    }),
    (fo.addAll = function (t) {
      var n,
        e,
        r,
        i,
      ...
      for (e = 0; e < a; ++e)
        isNaN((r = +this._x.call(null, (n = t[e])))) ||
          ...
          o < f && (f = o),
          o > g && (g = o));
      if (c > d || h > p || f > g) return this;
      for (this.cover(c, h, f).cover(d, p, g), e = 0; e < a; ++e)
        io(this, u[e], s[e], l[e], t[e]);
      return this;
    }),
    (fo.cover = function (t, n, e) {
      ...
      if (isNaN(r))
        ...
        for (
          var l, c, h = a - r || 1, f = this._root;
          r > t || t >= a || i > n || n >= u || o > e || e >= s;
        ...
        if (
          ...
          if (x.length) {
            var b = (o + s) / 2,
              ...
              k = (u + c) / 2;
            m.push(
              new oo(x[7], b, w, k, s, l, c),
              new oo(x[6], o, w, k, b, l, c),
              new oo(x[5], b, a, k, s, w, c),
              new oo(x[4], o, a, k, b, w, c),
              new oo(x[3], b, w, u, s, l, k),
              new oo(x[2], o, w, u, b, l, k),
              new oo(x[1], b, a, u, s, w, k),
              new oo(x[0], o, a, u, b, w, k),
            ),
              (f = ((e >= k) << 2) | ((n >= w) << 1) | (t >= b)) &&
                ((h = m[m.length - 1]),
            ...
            var M = t - +this._x.call(null, x.data),
              z = n - +this._y.call(null, x.data),
              A = e - +this._z.call(null, x.data),
              S = M * M + z * z + A * A;
            if (S < r) {
              var C = Math.sqrt((r = S));
              (d = t - C),
              ...
              (y =
                ...
                y ===
                  (n[7] ||
                    ...
                    n[0]) &&
                !y.length &&
                (e ? (e[g] = y) : (this._root = y)),
              this)
            : ((this._root = i), this)
      );
    }),
    (fo.removeAll = function (t) {
      for (var n = 0, e = t.length; n < e; ++n) this.remove(t[n]);
      return this;
    }),
    (fo.root = function () {
    ...
    (fo.visit = function (t) {
      ...
      for (
        c &&
        l.push(
          new oo(c, this._x0, this._y0, this._z0, this._x1, this._y1, this._z1),
        );
        (n = l.pop());
        ...
        if (
          ...
          var h = (r + a) / 2,
            f = (i + u) / 2,
            d = (o + s) / 2;
          (e = c[7]) && l.push(new oo(e, h, f, d, a, u, s)),
            (e = c[6]) && l.push(new oo(e, r, f, d, h, u, s)),
            (e = c[5]) && l.push(new oo(e, h, i, d, a, f, s)),
            (e = c[4]) && l.push(new oo(e, r, i, d, h, f, s)),
            (e = c[3]) && l.push(new oo(e, h, f, o, a, u, d)),
            (e = c[2]) && l.push(new oo(e, r, f, o, h, u, d)),
            (e = c[1]) && l.push(new oo(e, h, i, o, a, f, d)),
            (e = c[0]) && l.push(new oo(e, r, i, o, h, f, d));
        }
      return this;
    }),
    (fo.visitAfter = function (t) {
      var n,
        e = [],
        r = [];
      for (
        ...
        if (i.length) {
          var o,
            ...
            d = (u + c) / 2,
            p = (s + h) / 2;
          (o = i[0]) && e.push(new oo(o, a, u, s, f, d, p)),
            (o = i[1]) && e.push(new oo(o, f, u, s, l, d, p)),
            (o = i[2]) && e.push(new oo(o, a, d, s, f, c, p)),
            (o = i[3]) && e.push(new oo(o, f, d, s, l, c, p)),
            (o = i[4]) && e.push(new oo(o, a, u, p, f, d, h)),
            (o = i[5]) && e.push(new oo(o, f, u, p, l, d, h)),
            (o = i[6]) && e.push(new oo(o, a, d, p, f, c, h)),
            (o = i[7]) && e.push(new oo(o, f, d, p, l, c, h));
        }
        r.push(n);
      }
  ...
  var ko = Math.PI * (3 - Math.sqrt(5)),
    Mo = (20 * Math.PI) / (9 + Math.sqrt(221));
  function zo(t, n) {
    n = n || 2;
    var e,
      r = Math.min(3, Math.max(1, Math.round(n))),
      i = 1,
      o = 0.001,
      ...
      f = (function () {
        let t = 1;
        return () => (t = (1664525 * t + 1013904223) % mo) / mo;
      })();
    function d() {
      ...
      for (var f = 0; f < n; ++f)
        for (
          ...
          null == (c = t[o]).fx
            ...
            : ((c.x = c.fx), (c.vx = 0)),
            r > 1 &&
              (null == c.fy ? (c.y += c.vy *= s) : ((c.y = c.fy), (c.vy = 0))),
            r > 2 &&
              (null == c.fz ? (c.z += c.vz *= s) : ((c.z = c.fz), (c.vz = 0)));
      return e;
    }
    function g() {
      for (var n, e = 0, i = t.length; e < i; ++e) {
        if (
          ...
          null != n.fy && (n.y = n.fy),
          null != n.fz && (n.z = n.fz),
          isNaN(n.x) || (r > 1 && isNaN(n.y)) || (r > 2 && isNaN(n.z)))
        ) {
          var o =
              10 *
              (r > 2 ? Math.cbrt(0.5 + e) : r > 1 ? Math.sqrt(0.5 + e) : e),
            a = e * ko,
            u = e * Mo;
          1 === r
            ? (n.x = o)
            : 2 === r
              ? ((n.x = o * Math.cos(a)), (n.y = o * Math.sin(a)))
              : ((n.x = o * Math.sin(a) * Math.cos(u)),
                (n.y = o * Math.cos(a)),
                (n.z = o * Math.sin(a) * Math.sin(u)));
        }
        (isNaN(n.vx) || (r > 1 && isNaN(n.vy)) || (r > 2 && isNaN(n.vz))) &&
          ((n.vx = 0), r > 1 && (n.vy = 0), r > 2 && (n.vz = 0));
      }
    }
    function y(n) {
      return n.initialize && n.initialize(t, f, r), n;
    }
    return (
      null == t && (t = []),
      g(),
      (e = {
        ...
        numDimensions: function (t) {
          return arguments.length
            ? ((r = Math.min(3, Math.max(1, Math.round(t)))), l.forEach(y), e)
            : r;
        },
        nodes: function (n) {
          return arguments.length ? ((t = n), g(), l.forEach(y), e) : t;
        },
        alpha: function (t) {
        ...
        randomSource: function (t) {
          return arguments.length ? ((f = t), l.forEach(y), e) : f;
        },
        force: function (t, n) {
          return arguments.length > 1
            ? (null == n ? l.delete(t) : l.set(t, y(n)), e)
            : l.get(t);
        },
        find: function () {
          var n,
  ...
  function Ao() {
    ...
    function c(r) {
      ...
      for (i = r, o = 0; o < a; ++o) (e = t[o]), u.visit(d);
    }
    function h() {
      if (t) {
        var n,
      ...
      if ((v * v) / l < _)
        return (
          _ < s &&
            ...
            _ < u && (_ = Math.sqrt(u * _)),
            (e.vx += (p * t.value * i) / _),
            n > 1 && (e.vy += (g * t.value * i) / _),
            n > 2 && (e.vz += (y * t.value * i) / _)),
          !0
        );
      if (!(t.length || _ >= s)) {
        (t.data !== e || t.next) &&
    ...
    return (
      (c.initialize = function (e, ...i) {
        (t = e),
          (r = i.find((t) => "function" == typeof t) || Math.random),
          (n = i.find((t) => [1, 2, 3].includes(t)) || 2),
          h();
      }),
      (c.strength = function (t) {
        return arguments.length
          ? ((a = "function" == typeof t ? t : po(+t)), h(), c)
          : a;
      }),
  ...
  function jo(t) {
    return t < 0 ? -To(-t, 1 / 3) : To(t, 1 / 3);
  }
  const Ro = Math.PI,
    Do = 2 * Ro,
    Io = Ro / 2,
    Uo = Number.MAX_SAFE_INTEGER || 9007199254740991,
    Fo = Number.MIN_SAFE_INTEGER || -9007199254740991,
    Lo = { x: 0, y: 0, z: 0 },
    qo = {
      Tvalues: [
      ...
      arcfn: function (t, n) {
        ...
        return void 0 !== e.z && (r += e.z * e.z), Oo(r);
      },
      compute: function (t, n, e) {
        ...
        if (r < 4) {
          let n,
            ...
            c = 0;
          2 === r
            ? ((o = [o[0], o[1], o[2], Lo]), (n = s), (a = i * t * 2), (u = l))
            : 3 === r &&
              ((n = s * i), (a = s * t * 3), (u = i * l * 3), (c = t * l));
          const h = {
          ...
          return (
            e && (h.z = n * o[0].z + a * o[1].z + u * o[2].z + c * o[3].z), h
          );
        }
        ...
        for (; a.length > 1; ) {
          for (let n = 0; n < a.length - 1; n++)
            (a[n] = {
              ...
              void 0 !== a[n].z && (a[n] = a[n].z + (a[n + 1].z - a[n].z) * t);
                ...
                : ((s *= i),
                  ...
                  4 === a.length
                    ? ((u = s + l + c + h),
                      {
                        x:
                          (s * a[0].x + l * a[1].x + c * a[2].x + h * a[3].x) /
                          u,
                        y:
                          (s * a[0].y + l * a[1].y + c * a[2].y + h * a[3].y) /
                          u,
                        z:
                          !!r &&
                          (s * a[0].z + l * a[1].z + c * a[2].z + h * a[3].z) /
                            u,
                        t: t,
                      })
                    : void 0))
      ...
      between: function (t, n, e) {
        return (
          (n <= t && t <= e) || qo.approximately(t, n) || qo.approximately(t, e)
        );
      },
      approximately: function (t, n, e) {
        return So(t - n) <= (e || 1e-6);
      },
      length: function (t) {
        const n = qo.Tvalues.length;
        let e = 0;
        for (let r, i = 0; i < n; i++)
          (r = 0.5 * qo.Tvalues[i] + 0.5),
            (e += qo.Cvalues[i] * qo.arcfn(r, t));
        return 0.5 * e;
      },
      ...
      lerp: function (t, n, e) {
        const r = { x: n.x + t * (e.x - n.x), y: n.y + t * (e.y - n.y) };
        return (
          void 0 !== n.z && void 0 !== e.z && (r.z = n.z + t * (e.z - n.z)), r
        );
      },
      ...
      pointsToString: function (t) {
        return "[" + t.map(qo.pointToString).join(", ") + "]";
      },
      copy: function (t) {
      ...
      lli4: function (t, n, e, r) {
        const i = t.x,
          ...
          c = r.x,
          h = r.y;
        return qo.lli8(i, o, a, u, s, l, c, h);
      },
      lli: function (t, n) {
        return qo.lli4(t, t.c, n, n.c);
      },
      makeline: function (t, n) {
        return new Qo(t.x, t.y, (t.x + n.x) / 2, (t.y + n.y) / 2, n.x, n.y);
      },
      findbbox: function (t) {
        let n = Uo,
          e = Uo,
          ...
          a.forEach(function (n) {
            n.virtual ||
              u.forEach(function (r) {
                ...
                a.length > 0 &&
                  ((a.c1 = n), (a.c2 = r), (a.s1 = t), (a.s2 = e), o.push(a));
              });
          }),
          o
        );
      ...
      makeshape: function (t, n, e) {
        const r = n.points.length,
          i = t.points.length,
          o = qo.makeline(n.points[r - 1], t.points[0]),
          a = qo.makeline(t.points[i - 1], n.points[0]),
          u = {
            startcap: o,
            forward: t,
            back: n,
            endcap: a,
            bbox: qo.findbbox([o, t, n, a]),
            intersections: function (t) {
              return qo.shapeintersections(u, u.bbox, t, t.bbox, e);
            },
          };
        return u;
      },
      ...
      align: function (t, n) {
        const e = n.p1.x,
          r = n.p1.y,
          i = -Po(n.p2.y - r, n.p2.x - e);
        return t.map(function (t) {
          return {
            x: (t.x - e) * Co(i) - (t.y - r) * Eo(i),
            y: (t.x - e) * Eo(i) + (t.y - r) * Co(i),
          };
        });
      },
      roots: function (t, n) {
        ...
        let s = 3 * a - o - 3 * u + r[3].y,
          ...
          c = -3 * o + 3 * a,
          h = o;
        if (qo.approximately(s, 0)) {
          if (qo.approximately(l, 0))
            return qo.approximately(c, 0) ? [] : [-h / c].filter(i);
          const t = Oo(c * c - 4 * l * h),
            n = 2 * l;
        ...
        {
          const t = Oo(y);
          return (v = jo(-g + t)), (_ = jo(g + t)), [v - _ - l / 3].filter(i);
        }
      },
      droots: function (t) {
        if (3 === t.length) {
      ...
      curvature: function (t, n, e, r, i) {
        let o,
          ...
          l = 0,
          c = 0;
        const h = qo.compute(t, n),
          f = qo.compute(t, e),
          d = h.x * h.x + h.y * h.y;
        if (
          (r
            ? ((o = Oo(
                To(h.y * f.z - f.y * h.z, 2) +
                  To(h.z * f.x - f.z * h.x, 2) +
                  To(h.x * f.y - f.x * h.y, 2),
              )),
              (a = To(d + h.z * h.z, 1.5)))
            : ((o = h.x * f.y - h.y * f.x), (a = To(d, 1.5))),
          0 === o || 0 === a)
        )
          return { k: 0, r: 0 };
        if (((l = o / a), (c = a / o), !i)) {
          const i = qo.curvature(t - 0.001, n, e, r, !0).k,
            o = qo.curvature(t + 0.001, n, e, r, !0).k;
          (s = (o - l + (l - i)) / 2), (u = (So(o - l) + So(l - i)) / 2);
        }
        return { k: l, r: c, dk: s, adk: u };
      },
      inflections: function (t) {
        if (t.length < 4) return [];
        const n = qo.align(t, { p1: t[0], p2: t.slice(-1)[0] }),
          e = n[2].x * n[1].y,
          r = n[3].x * n[1].y,
          i = n[1].x * n[2].y,
        ...
        const s = 2 * o;
        if (qo.approximately(s, 0)) return [];
        const l = a * a - 4 * o * u;
        if (l < 0) return [];
        const c = Math.sqrt(l);
      ...
      pairiteration: function (t, n, e) {
        ...
        let u = t.split(0.5),
          s = n.split(0.5),
          l = [
            { left: u.left, right: s.left },
            { left: u.left, right: s.right },
            { left: u.right, right: s.right },
            { left: u.right, right: s.left },
          ];
        l = l.filter(function (t) {
          return qo.bboxoverlap(t.left.bbox(), t.right.bbox());
        });
        let c = [];
        return (
          0 === l.length ||
            (l.forEach(function (t) {
              c = c.concat(qo.pairiteration(t.left, t.right, a));
            }),
      ...
      getccenter: function (t, n, e) {
        const r = n.x - t.x,
          ...
          v = d + l,
          _ = p + c,
          m = qo.lli8(h, f, g, y, d, p, v, _),
          x = qo.dist(m, t);
        let b,
          w = Po(t.y - m.y, t.x - m.x),
          k = Po(n.y - m.y, n.x - m.x),
          M = Po(e.y - m.y, e.x - m.x);
        return (
          w < M
            ? ((w > k || k > M) && (w += Do),
              w > M && ((b = M), (M = w), (w = b)))
  ...
  class Bo {
    ...
    toString() {
      return (
        ...
        this.curves
          .map(function (t) {
            return qo.pointsToString(t.points);
          })
          .join(", ") +
        "]"
      );
    ...
    bbox() {
      const t = this.curves;
      for (var n = t[0].bbox(), e = 1; e < t.length; e++)
        qo.expandbox(n, t[e].bbox());
      return n;
    }
    offset(t) {
      const n = [];
  ...
  class Qo {
    constructor(t) {
      ...
      const c = qo.align(a, { p1: a[0], p2: a[s] }),
        h = qo.dist(a[0], a[s]);
      (this._linear = c.reduce((t, n) => t + $o(n.y), 0) < h / 50),
        (this._lut = []),
        (this._t1 = 0),
        (this._t2 = 1),
        this.update();
    ...
    static quadraticFromPoints(t, n, e, r) {
      if ((void 0 === r && (r = 0.5), 0 === r)) return new Qo(n, n, e);
      if (1 === r) return new Qo(t, n, n);
      const i = Qo.getABC(2, t, n, e, r);
      return new Qo(t, i.A, e);
    }
    static cubicFromPoints(t, n, e, r, i) {
      void 0 === r && (r = 0.5);
      const o = Qo.getABC(3, t, n, e, r);
      void 0 === i && (i = qo.dist(n, o.C));
      const a = (i * (1 - r)) / r,
        u = qo.dist(t, e),
        s = (e.x - t.x) / u,
        l = (e.y - t.y) / u,
        ...
        b = _.x + (y - _.x) / r,
        w = _.y + (v - _.y) / r,
        k = { x: t.x + (m - t.x) / r, y: t.y + (x - t.y) / r },
        M = { x: e.x + (b - e.x) / (1 - r), y: e.y + (w - e.y) / (1 - r) };
      return new Qo(t, k, M, e);
    }
    static getUtils() {
      return qo;
    }
    ...
    computedirection() {
      const t = this.points,
        n = qo.angle(t[0], t[this.order], t[1]);
      this.clockwise = n > 0;
    }
    length() {
      return qo.length(this.derivative.bind(this));
    }
    static getABC(t = 2, n, e, r, i = 0.5) {
      const o = qo.projectionratio(i, t),
        a = 1 - o,
        u = { x: o * n.x + a * r.x, y: o * n.y + a * r.y },
        s = qo.abcratio(i, t);
      return {
        A: { x: e.x + (e.x - u.x) / s, y: e.y + (e.y - u.y) / s },
        B: e,
        C: u,
        S: n,
        E: r,
    ...
    getABC(t, n) {
      ...
      return Qo.getABC(this.order, e, n, r, t);
    }
    getLUT(t) {
      if ((this.verify(), (t = t || 100), this._lut.length === t))
        return this._lut;
      (this._lut = []), t++, (this._lut = []);
      for (let n, e, r = 0; r < t; r++)
        (e = r / (t - 1)), (n = this.compute(e)), (n.t = e), this._lut.push(n);
      return this._lut;
    }
    on(n, e) {
      e = e || 5;
      ...
      for (let t, o = 0, a = 0; o < r.length; o++)
        (t = r[o]), qo.dist(t, n) < e && (i.push(t), (a += o / r.length));
    ...
    project(t) {
      ...
      let s,
        ...
        f = h;
      for (c += 1; h < a + u; h += u)
        (s = this.compute(h)), (l = qo.dist(t, s)), l < c && ((c = l), (f = h));
      return (
        (f = f < 0 ? 0 : f > 1 ? 1 : f),
        (s = this.compute(f)),
        (s.t = f),
    ...
    compute(t) {
      return this.ratios
        ? qo.computeWithRatios(t, this.points, this.ratios, this._3d)
        : qo.compute(t, this.points, this._3d, this.ratios);
    }
    raise() {
      const t = this.points,
        n = [t[0]],
        e = t.length;
      for (let r, i, o = 1; o < e; o++)
        (r = t[o]),
          (i = t[o - 1]),
          (n[o] = {
            x: ((e - o) / e) * r.x + (o / e) * i.x,
      ...
      return (n[e] = t[e - 1]), new Qo(n);
    }
    derivative(t) {
      return qo.compute(t, this.dpoints[0], this._3d);
    }
    dderivative(t) {
      return qo.compute(t, this.dpoints[1], this._3d);
    }
    align() {
      let t = this.points;
      return new Qo(qo.align(t, { p1: t[0], p2: t[t.length - 1] }));
    }
    curvature(t) {
      return qo.curvature(t, this.dpoints[0], this.dpoints[1], this._3d);
    }
    inflections() {
    ...
    __normal2(t) {
      const n = this.derivative(t),
        e = Wo(n.x * n.x + n.y * n.y);
      return { t: t, x: -n.y / e, y: n.x / e };
    }
    __normal3(t) {
      const n = this.derivative(t),
        e = this.derivative(t + 0.01),
        r = Wo(n.x * n.x + n.y * n.y + n.z * n.z),
        i = Wo(e.x * e.x + e.y * e.y + e.z * e.z);
    ...
    hull(t) {
      ...
      for (
        r[i++] = n[0],
          r[i++] = n[1],
          r[i++] = n[2],
          3 === this.order && (r[i++] = n[3]);
        n.length > 1;

      ) {
        e = [];
        for (let o, a = 0, u = n.length - 1; a < u; a++)
          (o = qo.lerp(t, n[a], n[a + 1])), (r[i++] = o), e.push(o);
        n = e;
      }
      return r;
    }
      ...
      const e = this.hull(t),
        r = {
          left:
            2 === this.order
              ? new Qo([e[0], e[3], e[5]])
              : new Qo([e[0], e[4], e[7], e[9]]),
          right:
            2 === this.order
              ? new Qo([e[5], e[4], e[2]])
              : new Qo([e[9], e[8], e[6], e[3]]),
          span: e,
        };
      return (
        (r.left._t1 = qo.map(0, 0, 1, this._t1, this._t2)),
        (r.left._t2 = qo.map(t, 0, 1, this._t1, this._t2)),
        (r.right._t1 = qo.map(t, 0, 1, this._t1, this._t2)),
        (r.right._t2 = qo.map(1, 0, 1, this._t1, this._t2)),
        n ? ((n = qo.map(n, t, 1, 0, 1)), r.right.split(n).left) : r
      );
    }
    extrema() {
      const t = {};
      ...
      return (
        this.dims.forEach(
          function (e) {
            ...
            (t[e] = qo.droots(i)),
              3 === this.order &&
                ((i = this.dpoints[1].map(r)),
                (t[e] = t[e].concat(qo.droots(i)))),
              (t[e] = t[e].filter(function (t) {
                return t >= 0 && t <= 1;
              })),
              (n = n.concat(t[e].sort(qo.numberSort)));
          }.bind(this),
        ),
        (t.values = n.sort(qo.numberSort).filter(function (t, e) {
    ...
    overlaps(t) {
      const n = this.bbox(),
        e = t.bbox();
      return qo.bboxoverlap(n, e);
    }
    offset(t, n) {
      if (void 0 !== n) {
        const e = this.get(t),
          r = this.normal(t),
          i = { c: e, n: r, x: e.x + r.x * n, y: e.y + r.y * n };
        return this._3d && (i.z = e.z + r.z * n), i;
      }
      if (this._linear) {
        const n = this.normal(0),
          e = this.points.map(function (e) {
            const r = { x: e.x + t * n.x, y: e.y + t * n.y };
    ...
    simple() {
      if (3 === this.order) {
        const t = qo.angle(this.points[0], this.points[3], this.points[1]),
          n = qo.angle(this.points[0], this.points[3], this.points[2]);
        if ((t > 0 && n < 0) || (t < 0 && n > 0)) return !1;
      }
      const t = this.normal(0),
        n = this.normal(1);
      let e = t.x * n.x + t.y * n.y;
      return this._3d && (e += t.z * n.z), $o(Yo(e)) < Zo / 3;
    }
    reduce() {
      let t,
        n,
      ...
      for (
        -1 === u.indexOf(0) && (u = [0].concat(u)),
          -1 === u.indexOf(1) && u.push(1),
          e = u[0],
          t = 1;
        t < u.length;
        t++
          ...
          for (e = 0, r = 0; r <= 1; )
            for (r = e + i; r <= 1.01; r += i)
              if (((n = t.split(e, r)), !n.simple())) {
                if (((r -= i), $o(e - r) < i)) return [];
                (n = t.split(e, r)),
                  (n._t1 = qo.map(e, 0, 1, t._t1, t._t2)),
                  (n._t2 = qo.map(r, 0, 1, t._t1, t._t2)),
                  a.push(n),
                  (e = r);
                break;
              }
    ...
    scale(t) {
      const n = this.order;
      let e = !1;
      if (("function" == typeof t && (e = t), e && 2 === n))
        return this.raise().scale(e);
      const r = this.clockwise,
        i = this.points;
      if (this._linear)
        return this.translate(this.normal(0), e ? e(0) : t, e ? e(1) : t);
      const o = e ? e(0) : t,
        a = e ? e(1) : t,
        u = [this.offset(0, 10), this.offset(1, 10)],
        s = [],
        l = qo.lli4(u[0], u[0].c, u[1], u[1].c);
      if (!l)
        throw new Error("cannot scale this curve. Try reducing it first.");
      return (
        [0, 1].forEach(function (t) {
          const e = (s[t * n] = qo.copy(i[t * n]));
        ...
        e
          ? ([0, 1].forEach(function (o) {
              if (2 !== n || !o) {
                var a = i[o + 1],
                  u = { x: a.x - l.x, y: a.y - l.y },
                  c = e ? e((o + 1) / n) : t;
                e && !r && (c = -c);
                var h = Wo(u.x * u.x + u.y * u.y);
                (u.x /= h),
                  (u.y /= h),
                  (s[o + 1] = { x: a.x + c * u.x, y: a.y + c * u.y });
              }
            }),
            new Qo(s))
          : ([0, 1].forEach((t) => {
              ...
              const e = s[t * n],
                r = this.derivative(t),
                o = { x: e.x + r.x, y: e.y + r.y };
              s[t + 1] = qo.lli4(e, o, l, i[t + 1]);
            }),
            new Qo(s))
      );
    }
    outline(t, n, e, r) {
      if (((n = void 0 === n ? t : n), this._linear)) {
        ...
        let u, s, l;
        void 0 === e && ((e = t), (r = n)),
          (u = { x: o.x + i.x * t, y: o.y + i.y * t }),
          (l = { x: a.x + i.x * e, y: a.y + i.y * e }),
          (s = { x: (u.x + l.x) / 2, y: (u.y + l.y) / 2 });
        const c = [u, s, l];
        (u = { x: o.x - i.x * n, y: o.y - i.y * n }),
          (l = { x: a.x - i.x * r, y: a.y - i.y * r }),
          (s = { x: (u.x + l.x) / 2, y: (u.y + l.y) / 2 });
        const h = [l, s, u],
          f = qo.makeline(h[2], c[0]),
          d = qo.makeline(c[2], h[0]),
          p = [f, new Qo(c), d, new Qo(h)];
        return new Bo(p);
      }
      const i = this.reduce(),
        o = i.length,
      ...
      let u,
        ...
        l = 0,
        c = this.length();
      const h = void 0 !== e && void 0 !== r;
      function f(t, n, e, r, i) {
        return function (o) {
          const a = r / e,
            u = (r + i) / e,
            s = n - t;
          return qo.map(o, 0, 1, t + a * s, t + u * s);
        };
      }
      i.forEach(function (i) {
        const o = i.length();
        h
          ? (a.push(i.scale(f(t, e, c, l, o))),
            s.push(i.scale(f(-n, -r, c, l, o))))
          : (a.push(i.scale(t)), s.push(i.scale(-n))),
          (l += o);
      }),
        (s = s
          .map(function (t) {
            return (
              (u = t.points),
              u[3]
                ? (t.points = [u[3], u[2], u[1], u[0]])
                : (t.points = [u[2], u[1], u[0]]),
              t
            );
          })
          .reverse());
      const d = a[0].points[0],
        p = a[o - 1].points[a[o - 1].points.length - 1],
        g = s[o - 1].points[s[o - 1].points.length - 1],
        y = s[0].points[0],
        v = qo.makeline(g, d),
        _ = qo.makeline(p, y),
    ...
    outlineshapes(t, n, e) {
      ...
      for (let t = 1, n = r.length; t < n / 2; t++) {
        const o = qo.makeshape(r[t], r[n - t], e);
        (o.startcap.virtual = t > 1),
          (o.endcap.virtual = t < n / 2 - 1),
          i.push(o);
      }
      return i;
    }
    intersects(t, n) {
      return t
        ? t.p1 && t.p2
          ...
          : (t instanceof Qo && (t = t.reduce()),
            this.curveintersects(this.reduce(), t, n))
        : this.selfintersects(n);
    }
    lineIntersects(t) {
      const n = Ho(t.p1.x, t.p2.x),
        e = Ho(t.p1.y, t.p2.y),
        r = Vo(t.p1.x, t.p2.x),
        i = Vo(t.p1.y, t.p2.y);
      return qo.roots(this.points, t).filter((t) => {
        var o = this.get(t);
        return qo.between(o.x, n, r) && qo.between(o.y, e, i);
      });
    }
    selfintersects(t) {
      const n = this.reduce(),
        e = n.length - 2,
        r = [];
      for (let i, o, a, u = 0; u < e; u++)
        (o = n.slice(u, u + 1)),
          (a = n.slice(u + 2)),
          (i = this.curveintersects(o, a, t)),
          r.push(...i);
      return r;
    }
    curveintersects(t, n, e) {
      ...
      return (
        r.forEach(function (t) {
          const n = qo.pairiteration(t.left, t.right, e);
      ...
      do {
        ...
        do {
          if (
            ...
            (o = this.get(d)),
            (a = this.get(i)),
            (u = qo.getccenter(c, o, a)),
            (u.interval = { start: r, end: i }),
            (h = this._error(u, c, r, i) <= t),
            (l = f && !h),
            l || (p = i),
            h)
          ) {
            if (i >= 1) {
              if (((u.interval.end = p = 1), (s = u), i > 1)) {
                let t = { x: u.x + u.r * Go(u.e), y: u.y + u.r * Xo(u.e) };
                u.e += qo.angle({ x: u.x, y: u.y }, t, this.get(1));
              }
              break;
            }
            i += (i - r) / 2;
  ...
  var la = function (t, n) {
    ...
    ca = function (t, n) {
      if (!n.isShadow) {
        var e = ti(n.linkDirectionalParticles);
        n.graphData.links.forEach(function (t) {
          var n = Math.round(Math.abs(e(t)));
          n
            ? (t.__photons = l(Array(n)).map(function () {
                return {};
              }))
            : delete t.__photons;
        });
    ...
    ha = Jr({
      props: {
        graphData: {
          ...
          onChange: function (t, n) {
            (n.engineRunning = !1), ca(0, n);
          },
        },
        dagMode: {
          onChange: function (t, n) {
            !t &&
              (n.graphData.nodes || []).forEach(function (t) {
        ...
        nodeRelSize: { default: 4, triggerUpdate: !1, onChange: la },
        nodeId: { default: "id" },
        nodeVal: { default: "val", triggerUpdate: !1, onChange: la },
        nodeColor: { default: "color", triggerUpdate: !1, onChange: la },
        nodeAutoColorBy: {},
        nodeCanvasObject: { triggerUpdate: !1, onChange: la },
        ...
        nodeVisibility: { default: !0, triggerUpdate: !1, onChange: la },
        linkSource: { default: "source" },
        linkTarget: { default: "target" },
        linkVisibility: { default: !0, triggerUpdate: !1, onChange: la },
        linkColor: { default: "color", triggerUpdate: !1, onChange: la },
        linkAutoColorBy: {},
        linkLineDash: { triggerUpdate: !1, onChange: la },
        linkWidth: { default: 1, triggerUpdate: !1, onChange: la },
        linkCurvature: { default: 0, triggerUpdate: !1, onChange: la },
        linkCanvasObject: { triggerUpdate: !1, onChange: la },
        ...
        linkDirectionalArrowColor: { triggerUpdate: !1, onChange: la },
      ...
      methods: {
        d3Force: function (t, n, e) {
          return void 0 === e
            ? t.forceLayout.force(n)
            : (t.forceLayout.force(n, e), this);
        },
        ...
        tickFrame: function (t) {
          ...
          return (
            ...
            (function () {
              var n = ti(t.linkVisibility),
                e = ti(t.linkColor),
                r = ti(t.linkWidth),
                i = ti(t.linkLineDash),
                o = ti(t.linkCurvature),
                a = ti(t.linkCanvasObjectMode),
                u = t.ctx,
                c = 2 * t.isShadow,
              ...
              h.forEach(function (t) {
                ...
                var e = t.source,
                  r = t.target;
                if (!(e && r && e.hasOwnProperty("x") && r.hasOwnProperty("x")))
                  return;
                var i = Math.sqrt(
                  Math.pow(r.x - e.x, 2) + Math.pow(r.y - e.y, 2),
                );
                if (i > 0) {
              ...
              if (t.linkCanvasObject) {
                var g = [],
                  y = [];
                h.forEach(function (t) {
                  return ({ before: f, after: d, replace: g }[a(t)] || y).push(
                    t,
                  );
                }),
                  (p = [].concat(l(f), d, y)),
              ...
              var v = (function () {
                var t =
                  ...
                  r =
                    ...
                    arguments[3],
                  i = (
                    n instanceof Array ? (n.length ? n : [void 0]) : [n]
                  ).map(function (t) {
                    ...
                    (function t(n) {
                      var e =
                        arguments.length > 1 && void 0 !== arguments[1]
                          ...
                          : [];
                      e.length === i.length
                        ? a.push({ keys: e, vals: n })
                        : Object.entries(n).forEach(function (n) {
                            var r = Jo(n, 2),
                              i = r[0],
                              o = r[1];
                            return t(o, [].concat(ta(e), [i]));
                          });
                    })(o),
                    n instanceof Array &&
                      0 === n.length &&
              ...
              u.save(),
                Object.entries(v).forEach(function (n) {
                  var e = s(n, 2),
                    r = e[0],
                    o = e[1],
            ...
            !t.isShadow &&
              ((n = ti(t.linkDirectionalArrowLength)),
              (e = ti(t.linkDirectionalArrowRelPos)),
              (r = ti(t.linkVisibility)),
              (i = ti(t.linkDirectionalArrowColor || t.linkColor)),
              (o = ti(t.nodeVal)),
              (a = t.ctx).save(),
                ...
                if (s && !(s < 0)) {
                  ...
                  if (
                    ...
                    var f = Math.sqrt(Math.max(0, o(c) || 1)) * t.nodeRelSize,
                      d = Math.sqrt(Math.max(0, o(h) || 1)) * t.nodeRelSize,
                      p = Math.min(1, Math.max(0, e(r))),
                      g = i(r) || "rgba(0,0,0,0.28)",
                      y = s / 1.6 / 2,
                      v =
                        r.__controlPoints &&
                        u(
                          Qo,
                          [c.x, c.y].concat(l(r.__controlPoints), [h.x, h.y]),
                        ),
                      _ = v
                        ? function (t) {
                            return v.get(t);
                      ...
                      m = v
                        ? v.length()
                        : Math.sqrt(
                            Math.pow(h.x - c.x, 2) + Math.pow(h.y - c.y, 2),
                          ),
                      x = f + s + (m - f - d - s) * p,
                      b = _(x / m),
                      w = _((x - s) / m),
                      k = _((x - 0.8 * s) / m),
                      M = Math.atan2(b.y - w.y, b.x - w.x) - Math.PI / 2;
                    a.beginPath(),
                      a.moveTo(b.x, b.y),
                      a.lineTo(w.x + y * Math.cos(M), w.y + y * Math.sin(M)),
                      a.lineTo(k.x, k.y),
                      a.lineTo(w.x - y * Math.cos(M), w.y - y * Math.sin(M)),
                      (a.fillStyle = g),
                      a.fill();
            ...
            !t.isShadow &&
              (function () {
                var n = ti(t.linkDirectionalParticles),
                  e = ti(t.linkDirectionalParticleSpeed),
                  r = ti(t.linkDirectionalParticleWidth),
                  i = ti(t.linkVisibility),
                  o = ti(t.linkDirectionalParticleColor || t.linkColor),
                  a = t.ctx;
                a.save(),
                  t.graphData.links.filter(i).forEach(function (i) {
                    ...
                    if (i.hasOwnProperty("__photons") && i.__photons.length) {
                      ...
                      if (
                        ...
                        var f = e(i),
                          d = i.__photons || [],
                          p = Math.max(0, r(i) / 2) / Math.sqrt(t.globalScale),
                          g = o(i) || "rgba(0,0,0,0.28)";
                        a.fillStyle = g;
                        var y = i.__controlPoints
                            ? u(
                                Qo,
                                [c.x, c.y].concat(l(i.__controlPoints), [
                                  h.x,
                                  h.y,
                                ]),
                              )
                        ...
                        d.forEach(function (t) {
                          var n = !!t.__singleHop;
                          if (
                            (t.hasOwnProperty("__progressRatio") ||
                              (t.__progressRatio = n ? 0 : v / s),
                            !n && v++,
                            (t.__progressRatio += f),
                            t.__progressRatio >= 1)
                          ) {
            ...
            (function () {
              var n = ti(t.nodeVisibility),
                e = ti(t.nodeVal),
                r = ti(t.nodeColor),
                i = ti(t.nodeCanvasObjectMode),
                o = t.ctx,
              ...
              o.save(),
                u.forEach(function (n) {
                  ...
                  if (
                    !t.nodeCanvasObject ||
                    ("before" !== u && "replace" !== u) ||
                    (t.nodeCanvasObject(n, o, t.globalScale), "replace" !== u)
                  ) {
                    var s =
                      Math.sqrt(Math.max(0, e(n) || 1)) * t.nodeRelSize + a;
                    o.beginPath(),
                      o.arc(n.x, n.y, s, 0, 2 * Math.PI, !1),
                      (o.fillStyle = r(n) || "rgba(31, 120, 180, 0.92)"),
                      o.fill(),
                      t.nodeCanvasObject &&
                        "after" === u &&
                        t.nodeCanvasObject(n, t.ctx, t.globalScale);
                  } else o.restore();
                }),
                o.restore();
            })(),
        ...
        emitParticle: function (t, n) {
          return (
            n &&
              (!n.__photons && (n.__photons = []),
              n.__photons.push({ __singleHop: !0 })),
            this
          );
        },
      },
      ...
      update: function (t) {
        (t.engineRunning = !1),
          ...
          null !== t.nodeAutoColorBy &&
            sa(t.graphData.nodes, ti(t.nodeAutoColorBy), t.nodeColor),
          null !== t.linkAutoColorBy &&
            sa(t.graphData.links, ti(t.linkAutoColorBy), t.linkColor),
        ...
        var e =
            ...
            (function (t, n) {
              var e = t.nodes,
                ...
                d = {};
              e.forEach(function (t) {
                return (d[n(t)] = { data: t, out: [], depth: -1, skip: !c(t) });
              }),
                o.forEach(function (t) {
                  var e = t.source,
                    i = t.target,
                  ...
                  if (!d.hasOwnProperty(a))
                    throw "Missing target node with id: ".concat(a);
                  var u = d[o],
                    s = d[a];
                  function l(t) {
                    return "object" === r(t) ? n(t) : t;
                  }
                  u.out.push(s);
                });
              var p = [];
              y(Object.values(d));
              var g = Object.assign.apply(
                Object,
                [{}].concat(
                  l(
                    Object.entries(d)
                ...
                for (
                  var e =
                    ...
                    i = function () {
                      ...
                      if (-1 !== e.indexOf(i)) {
                        var a = []
                          .concat(l(e.slice(e.indexOf(i))), [i])
                          .map(function (t) {
                            return n(t.data);
                          });
                        return (
                      ...
                      r > i.depth &&
                        ((i.depth = r),
                        y(i.out, [].concat(l(e), [i]), r + (i.skip ? 0 : 1)));
                    },
                    o = 0,
                    a = t.length;
                  o < a;
          ...
          o = Math.max.apply(Math, l(Object.values(e || []))),
          a =
            t.dagLevelDistance ||
        ...
        if (t.dagMode) {
          var u = function (n, r) {
              return function (i) {
                return n ? (e[i[t.nodeId]] - o / 2) * a * (r ? -1 : 1) : void 0;
              };
            },
            c = u(-1 !== ["lr", "rl"].indexOf(t.dagMode), "rl" === t.dagMode),
            h = u(-1 !== ["td", "bu"].indexOf(t.dagMode), "bu" === t.dagMode);
            ...
            ? (function (t, n, e, r) {
                ...
                return (
                  ...
                  (l.strength = function (t) {
                    return arguments.length
                      ? ((s = "function" == typeof t ? t : po(+t)), c(), l)
                      : s;
                  }),
                  (l.radius = function (n) {
                    return arguments.length
                      ? ((t = "function" == typeof n ? n : po(+n)), c(), l)
                      : t;
                  }),
                  (l.x = function (t) {
                ...
                var r = e[n[t.nodeId]] || -1;
                return ("radialin" === t.dagMode ? o - r : r) * a;
              }).strength(function (n) {
  ...
  var da = fa("forceGraph", ha),
    pa = fa(["forceGraph", "shadowGraph"], ha),
      ...
      l(
        ...
        l(
          [
            ...
            return i({}, t, pa.linkProp(t));
          }),
        ),
      ),
    ),
    ya = Object.assign.apply(
      Object,
      l(
        ["d3Force", "d3ReheatSimulation", "emitParticle"].map(function (t) {
          return i({}, t, da.linkMethod(t));
        }),
      ),
    );
  function va(t) {
  ...
  function ma(t, n, e) {
    t.save(), _a(t), t.clearRect(0, 0, n, e), t.restore();
  }
  var xa = Jr({
    props: e(
      {
        ...
        graphData: {
          ...
          onChange: function (t, n) {
            [
              ...
              n.forceGraph.graphData(t),
              n.shadowGraph.graphData(t);
          },
          triggerUpdate: !1,
        },
        backgroundColor: {
          ...
          if (void 0 !== n || void 0 !== e) {
            ...
            return (
              r
                ? new Vr.Tween(o())
                    .to(i, r)
                    .easing(Vr.Easing.Quadratic.Out)
                    .onUpdate(a)
                    .start()
                : a(i),
              this
          ...
          if (a) {
            var u = { x: (a.x[0] + a.x[1]) / 2, y: (a.y[0] + a.y[1]) / 2 },
              s = Math.max(
                ...
                Math.min(
                  1e12,
                  (t.width - 2 * e) / (a.x[1] - a.x[0]),
                  (t.height - 2 * e) / (a.y[1] - a.y[0]),
                ),
              );
    ...
    init: function (t, n) {
      ...
      var o = n.canvas.getContext("2d"),
        a = n.shadowCanvas.getContext("2d", { willReadFrequently: !0 }),
        u = { x: -1e12, y: -1e12 },
        s = function () {
          var t = null,
            ...
            r =
              u.x > 0 && u.y > 0
                ? a.getImageData(u.x * e, u.y * e, 1, 1)
                : null;
        ...
        (function () {
          ...
          function d(a, u) {
            if (!r && i.call(this, a, u)) {
              ...
              s &&
                (At(a.view)
                  .on("mousemove.drag", p, Rt)
                  .on("mouseup.drag", g, Rt),
                Ut(a.view),
                Dt(a),
                (e = !1),
                (t = a.clientX),
          ...
          function g(t) {
            At(t.view).on("mousemove.drag mouseup.drag", null),
              Ft(t.view, e),
              It(t),
              s.mouse("end", t);
          }
          function y(t, n) {
            if (i.call(this, t, n)) {
              var e,
                ...
                s = a.length;
              for (e = 0; e < s; ++e)
                (r = m(this, u, t, n, a[e].identifier, a[e])) &&
                  (Dt(t), r("start", t, a[e]));
            }
          }
          function v(t) {
            var n,
              ...
              i = r.length;
            for (n = 0; n < i; ++n)
              (e = s[r[n].identifier]) && (It(t), e("drag", t, r[n]));
          }
          function _(t) {
            var n,
              e,
            ...
            for (
              ...
              (e = s[i[n].identifier]) && (Dt(t), e("end", t, i[n]));
          }
          ...
          return (
            (f.filter = function (t) {
              return arguments.length
                ? ((i = "function" == typeof t ? t : Lt(!!t)), f)
                : i;
            }),
            (f.container = function (t) {
              return arguments.length
                ? ((o = "function" == typeof t ? t : Lt(t)), f)
                : o;
            }),
            (f.subject = function (t) {
              return arguments.length
                ? ((a = "function" == typeof t ? t : Lt(t)), f)
                : a;
            }),
            (f.touchable = function (t) {
              return arguments.length
                ? ((u = "function" == typeof t ? t : Lt(!!t)), f)
                : u;
            }),
            (f.on = function () {
          ...
          .on("end", function (t) {
            var e = t.subject,
              r = e.__initialDragPos,
              i = { x: e.x - r.x, y: e.y - r.y };
            void 0 === r.fx && (e.fx = void 0),
              void 0 === r.fy && (e.fy = void 0),
              delete e.__initialDragPos,
              n.forceGraph.d3AlphaTarget() &&
                n.forceGraph.d3AlphaTarget(0).resetCountdown(),
              n.canvas.classList.remove("grabbable"),
              (n.isPointerDragging = !1),
              e.__dragged && (delete e.__dragged, n.onNodeDragEnd(e, i));
          }),
      ),
        n.zoom((n.zoom.__baseElem = At(n.canvas))),
        ...
        n.zoom
          .filter(function (t) {
            return (
              ...
              (n.enableZoomInteraction || "wheel" !== t.type) &&
              (n.enablePanInteraction || "wheel" === t.type)
            );
          })
          .on("zoom", function (t) {
            var i = t.transform;
            [o, a].forEach(function (t) {
              _a(t), t.translate(i.x, i.y), t.scale(i.k, i.k);
            }),
              n.onZoom && n.onZoom(e(e({}, i), r.centerAt())),
              (n.needsRedraw = !0);
          })
          .on("end", function (t) {
            return (
              n.onZoomEnd && n.onZoomEnd(e(e({}, t.transform), r.centerAt()))
            );
          }),
        va(n),
        n.forceGraph
          ...
          .onFinishUpdate(function () {
            Ke(n.canvas).k === n.lastSetZoom &&
              n.graphData.nodes.length &&
              (n.zoom.scaleTo(
                n.zoom.__baseElem,
                (n.lastSetZoom = 4 / Math.cbrt(n.graphData.nodes.length)),
              ),
              (n.needsRedraw = !0));
          });
      var l = document.createElement("div");
      l.classList.add("graph-tooltip"),
        i.appendChild(l),
        ["pointermove", "pointerdown"].forEach(function (t) {
          return i.addEventListener(
            ...
            function (e) {
              "pointerdown" === t &&
                ((n.isPointerPressed = !0), (n.pointerDownEvent = e)),
                !n.isPointerDragging &&
                  "pointermove" === e.type &&
                  n.onBackgroundClick &&
                  (e.pressure > 0 || n.isPointerPressed) &&
                  ("touch" !== e.pointerType ||
                    void 0 === e.movementX ||
                    [e.movementX, e.movementY].some(function (t) {
                      return Math.abs(t) > 1;
                    })) &&
                  (n.isPointerDragging = !0);
              var r,
                ...
                s =
                  ...
                  { top: r.top + a, left: r.left + o });
              (u.x = e.pageX - s.left),
                (u.y = e.pageY - s.top),
                (l.style.top = "".concat(u.y, "px")),
                (l.style.left = "".concat(u.x, "px")),
                (l.style.transform = "translate(-"
                  .concat((u.x / n.width) * 100, "%, ")
                  .concat(
                    n.height - u.y < 100 ? "calc(-100% - 8px)" : "21px",
                    ")",
                  ));
            },
            { passive: !0 },
                ...
                if (2 === t.button)
                  if (n.hoverObj) {
                    ...
                    n.onBackgroundRightClick &&
                      n.onBackgroundRightClick.apply(n, e);
              });
            }
          },
          { passive: !0 },
      ...
      var c = Nr(function () {
        ma(a, n.width, n.height),
          n.shadowGraph.linkWidth(function (t) {
            return ti(n.linkWidth)(t) + n.linkHoverPrecision;
          });
        var t = Ke(n.canvas);
        n.shadowGraph.globalScale(t.k).tickFrame();
      }, 800);
      (n.flushShadowCanvas = c.flush),
        (this._animationCycle = function t() {
          var e =
            !n.autoPauseRedraw ||
            !!n.needsRedraw ||
            n.forceGraph.isEngineRunning() ||
            n.graphData.links.some(function (t) {
              return t.__photons && t.__photons.length;
            });
          if (((n.needsRedraw = !1), n.enablePointerInteraction)) {
            var r = n.isPointerDragging ? null : s();
            if (r !== n.hoverObj) {
              var i = n.hoverObj,
                a = i ? i.type : null,
                u = r ? r.type : null;
              if (a && a !== u) {
                var h = n["on".concat(a, "Hover")];
                h && h(null, i.d);
              }
              if (u) {
                var f = n["on".concat(u, "Hover")];
                f && f(r.d, a === u ? i.d : null);
              }
              var d =
                (r && ti(n["".concat(r.type.toLowerCase(), "Label")])(r.d)) ||
                "";
              (l.style.visibility = d ? "visible" : "hidden"),
                (l.innerHTML = d),
                n.canvas.classList[
                  (r && n["on".concat(u, "Click")]) ||
                  (!r && n.onBackgroundClick)
                    ? "add"
                    : "remove"
                ]("clickable"),
                (n.hoverObj = r);
          ...
          if (e) {
            ma(o, n.width, n.height);
            var p = Ke(n.canvas).k;
            n.onRenderFramePre && n.onRenderFramePre(o, p),
              n.forceGraph.globalScale(p).tickFrame(),
              n.onRenderFramePost && n.onRenderFramePost(o, p);
          }
          Vr.update(), (n.animationFrameRequestId = requestAnimationFrame(t));
        })();
    },
    update: function (t) {},
  });
