(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("leaflet"), require("vue"))
    : typeof define === "function" && define.amd
      ? define(["exports", "leaflet", "vue"], factory)
      : ((global = global || self),
        factory((global.Vue2Leaflet = {}), global.L, global.Vue));
})(this, function (exports, leaflet, Vue) {
  "use strict";
    ...
    methods: {
      ...
      createIcon: function createIcon() {
        ...
        if (
          ...
          this.parentContainer.mapObject.getElement().innerHTML =
            this.$el.innerHTML;
    ...
    methods: {
      ...
      fitBounds: function fitBounds(bounds, overrideOptions) {
        this.mapObject.fitBounds(
          bounds,
          Object.assign({}, this.fitBoundsOptions, overrideOptions),
        );
      },
    ...
    props: {
      bounds: {
        ...
        validator: function (value) {
          return value && leaflet.latLngBounds(value).isValid();
        },
      },
    },
    data: function data() {
