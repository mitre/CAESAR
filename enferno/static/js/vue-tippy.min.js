var VueTippy = (function (t) {
  ...
  function m(t, e) {
    ...
    if ((t !== s && e !== s) || r.contains(i))
      return "BODY" === (p = (a = s).nodeName) ||
        ("HTML" !== p && d(a.firstElementChild) !== a)
        ? d(s)
        : s;
    var c = u(t);
  ...
  function g(t) {
    ...
    return { height: v("Height", e, n, r), width: v("Width", e, n, r) };
  }
  var y = function (t, e) {
      if (!(t instanceof e))
  ...
  function C(t, e, n, r) {
    ...
    if ("viewport" === r)
      ...
      var f = void 0;
      "scrollParent" === r
        ? "BODY" === (f = p(a(e))).nodeName &&
          (f = t.ownerDocument.documentElement)
        : (f = "window" === r ? t.ownerDocument.documentElement : r);
      var d = A(f, l, i);
      if (
        "HTML" !== f.nodeName ||
        (function t(e) {
    ...
    return (
      (c.left += y ? n : n.left || 0),
      (c.top += y ? n : n.top || 0),
      (c.right -= y ? n : n.right || 0),
      (c.bottom -= y ? n : n.bottom || 0),
      c
    );
  }
        ...
        keepTogether: {
          ...
          fn: function (t) {
            var e = t.offsets,
              ...
              c = a ? "width" : "height";
            return (
              n[p] < o(r[s]) && (t.offsets.popper[s] = o(r[s]) - n[c]),
              n[s] > o(r[p]) && (t.offsets.popper[s] = o(r[p])),
              t
            );
          },
        },
        arrow: {
          ...
          fn: function (t, e) {
            ...
            var i = t.placement.split("-")[0],
              ...
              m = c ? "bottom" : "right",
              h = M(r)[l];
            s[m] - h < p[d] && (t.offsets.popper[d] -= p[d] - (s[m] - h)),
              s[d] + h > p[m] && (t.offsets.popper[d] += s[d] + h - p[m]),
            ...
            return (
              (w = Math.max(Math.min(p[l] - h, w), 0)),
              (t.arrowElement = r),
              (t.offsets.arrow =
                (x((n = {}), d, Math.round(w)), x(n, u, ""), n)),
              t
            );
          },
          element: "[x-arrow]",
          ...
          fn: function (t, e) {
            ...
            var a = void 0 !== o ? o : e.gpuAcceleration,
              ...
              l = (function (t, e) {
                ...
                return {
                  left: d(
                    s % 2 == 1 && c % 2 == 1 && !f && e ? r.left - 1 : r.left,
                  ),
                  top: u(r.top),
                  bottom: u(r.bottom),
                  right: d(r.right),
            ...
            if (
              ((b =
                "bottom" === f
                  ? "HTML" === p.nodeName
                    ? -p.clientHeight + l.bottom
                    : -s.height + l.bottom
                  : l.top),
              (h =
                "right" === u
                  ? "HTML" === p.nodeName
                    ? -p.clientWidth + l.right
                    : -s.width + l.right
                  : l.left),
              a && m)
            )
              (c[m] = "translate3d(" + h + "px, " + b + "px, 0)"),
                (c[f] = 0),
                (c[u] = 0),
              ...
              var v = "bottom" === f ? -1 : 1,
                g = "right" === u ? -1 : 1;
              (c[f] = b * v), (c[u] = h * g), (c.willChange = f + ", " + u);
            }
    ...
    G = (function () {
      function t(e, n) {
        ...
        y(this, t),
          ...
          Object.keys(k({}, t.Defaults.modifiers, a.modifiers)).forEach(
            function (e) {
              o.options.modifiers[e] = k(
                {},
  ...
  var Z = "undefined" != typeof window && "undefined" != typeof document,
    ...
    at =
      ot.matches ||
      ot.matchesSelector ||
      ot.webkitMatchesSelector ||
      ot.mozMatchesSelector ||
      ot.msMatchesSelector;
  function pt(t) {
    return [].slice.call(t);
  }
  function st(t, e) {
  ...
  function St() {
    Lt ||
      ((Lt = !0),
      nt && document.body.classList.add(mt),
      window.performance && document.addEventListener("mousemove", Dt));
  }
  var Mt = 0;
  function Dt() {
    ...
    t - Mt < 20 &&
      ((Lt = !1),
      document.removeEventListener("mousemove", Dt),
      nt || document.body.classList.remove(mt)),
      (Mt = t);
  }
  function It() {
  ...
  function Gt(t) {
    return {
      ...
      arrow: t.querySelector(Tt) || t.querySelector(Ct),
    };
  }
  function Jt(t) {
  ...
  function Qt() {
    var t = Wt();
    return (t.className = yt), t.setAttribute("data-state", "hidden"), t;
  }
  function te(t, e) {
  ...
  function ee(t, e, n) {
    var r =
      et && void 0 !== document.body.style.webkitTransition
        ? "webkitTransitionEnd"
        : "transitionend";
  ...
  function oe(t, e, n) {
    ...
    (t.style.zIndex = "" + n.zIndex),
      ...
      e.content !== n.content && Kt(o, n),
      !e.animateFill && n.animateFill
        ? (i.appendChild(Qt()), i.setAttribute("data-animatefill", ""))
        : e.animateFill &&
          !n.animateFill &&
          (i.removeChild(a), i.removeAttribute("data-animatefill")),
      !e.arrow && n.arrow
        ? i.appendChild(Zt(n.arrowType))
        : e.arrow && !n.arrow && i.removeChild(p),
      e.arrow &&
        n.arrow &&
        e.arrowType !== n.arrowType &&
        i.replaceChild(Zt(n.arrowType), p),
      ...
      e.theme !== n.theme && (re(i, "remove", e.theme), re(i, "add", n.theme));
  }
  var ae = 1,
    pe = [];
  function se(t, e) {
      ...
      k = {
        ...
        destroy: function (e) {
          ...
          n &&
            e &&
            jt(t) &&
            pt(t.querySelectorAll(n)).forEach(function (t) {
    ...
    function D(t, e) {
      ...
      A().addEventListener(t, e, n),
        v.push({ eventType: t, handler: e, options: n });
    }
    function I() {
      k.props.touchHold &&
        !k.props.target &&
        (D("touchstart", _, lt), D("touchend", Y, lt)),
        k.props.trigger
          .trim()
          .split(" ")
          .forEach(function (t) {
    ...
    function H(e) {
      ...
      if (f) {
        ...
        (!a && k.props.interactive) ||
          ((k.popperInstance.reference = J({}, k.popperInstance.reference, {
            referenceNode: t,
            clientWidth: 0,
            clientHeight: 0,
    ...
    function _(t) {
      k.state.isEnabled &&
        ...
        "click" === t.type && !1 !== k.props.hideOnClick && k.state.isVisible
          ? $()
          : V(t));
    }
    function P(e) {
      ...
      n ||
        ...
        ((function (t, e, n, r) {
          ...
          return s || c || l || f;
        })(ne(w), w.getBoundingClientRect(), e, k.props) &&
          (O(), $()));
    }
    function Y(t) {
      if (!z(t))
    ...
    function W() {
      ...
      function a(t) {
        k.props.flip &&
          ...
          (t.flipped && (k.popperInstance.options.placement = t.placement),
          Bt(k.popperInstance.modifiers, !1)),
          r.setAttribute(dt, t.placement),
          !1 !== t.attributes[ut]
            ? r.setAttribute(ut, "")
        ...
        (p[e] = a ? i + k.props.distance : (i[e] || 0) + k.props.distance),
          (k.popperInstance.modifiers.filter(function (t) {
            return "preventOverflow" === t.name;
          })[0].padding = p),
          (f = p);
      }
      var p = J({ eventsEnabled: !1, placement: k.props.placement }, e, {
        modifiers: J({}, e ? e.modifiers : {}, {
          preventOverflow: J(
            { boundariesElement: k.props.boundary, padding: ft },
            o,
          ),
          arrow: J({ element: i, enabled: !!i }, Yt(e, "arrow")),
          flip: J(
            {
          ...
          offset: J({ offset: k.props.offset }, Yt(e, "offset")),
        }),
        onCreate: function (t) {
    ...
    function V(t, n) {
      if ((U(), !k.state.isVisible)) {
        ...
        if (((u = !0), t && !n && k.props.onTrigger(k, t), k.props.wait))
          return k.props.wait(k, t);
        S() &&
          !k.state.isMounted &&
          (k.popperInstance || W(), document.addEventListener("mousemove", H)),
          T();
    ...
    function $() {
      if ((U(), !k.state.isVisible)) return E(), void C();
      u = !1;
    ...
    function q(e) {
      Ut((e = e || {}), rt), N();
      var n = k.props,
        i = Rt(t, J({}, k.props, {}, e, { ignoreAttributes: !0 }));
      (i.ignoreAttributes = Ht(e, "ignoreAttributes")
        ? e.ignoreAttributes || !1
        : n.ignoreAttributes),
        (k.props = i),
        I(),
        O(),
        (g = Pt(P, i.interactiveDebounce)),
        oe(w, n, i),
        (k.popperChildren = Gt(w)),
        k.popperInstance &&
          (it.some(function (t) {
            ...
            ? (k.popperInstance.destroy(),
              W(),
              k.state.isVisible && k.popperInstance.enableEventListeners(),
              k.props.followCursor && r && H(r))
            : k.popperInstance.update());
    }
    function K() {
      var e =
        arguments.length > 0 && void 0 !== arguments[0]
          ? arguments[0]
          : _t(k.props.duration, 0, rt.duration[1]);
      if (
        !k.state.isDestroyed &&
        k.state.isEnabled &&
        (!Lt || k.props.touch) &&
        ...
        T(),
          ...
          (k.state.isVisible = !0),
          k.props.interactive && A().classList.add(ht);
        var n = L();
        Vt(n.concat(w), 0),
          (c = function () {
            if (k.state.isVisible) {
              var i = S();
              i && r ? H(r) : i || k.popperInstance.update(),
                k.popperChildren.backdrop &&
                  ...
                  (function () {
                    ...
                    !(function n() {
                      ...
                      (e.top === r.top &&
                        ...
                        (e = r),
                        k.state.isMounted && requestAnimationFrame(n);
                    })();
                  })(),
                Vt([w], k.props.updateDuration),
                Vt(n, e),
                $t(n, "visible"),
                (function (t, e) {
                  M(t, e);
                  ...
                  k.props.aria &&
                    A().setAttribute("aria-".concat(k.props.aria), w.id),
                    k.props.onShown(k),
                    (k.state.isShown = !0);
                });
            }
          ...
          (function () {
            ...
            var e = S();
            k.popperInstance
              ? (Bt(k.popperInstance.modifiers, k.props.flip),
                e ||
                  ((k.popperInstance.reference = t),
                  k.popperInstance.enableEventListeners()),
                k.popperInstance.scheduleUpdate())
              : (W(), e || k.popperInstance.enableEventListeners());
            var n = k.props.appendTo,
              r = "parent" === n ? t.parentNode : zt(n, [t]);
            r.contains(w) ||
              (r.appendChild(w), k.props.onMount(k), (k.state.isMounted = !0));
          })();
      }
    }
    function Z() {
      var t =
        arguments.length > 0 && void 0 !== arguments[0]
          ? arguments[0]
          : _t(k.props.duration, 1, rt.duration[1]);
      if (
        !k.state.isDestroyed &&
        (k.state.isEnabled || m) &&
        (!1 !== k.props.onHide(k) || m)
      ) {
        C(),
          ...
          (k.state.isShown = !1),
          (h = !1),
          k.props.interactive && A().classList.remove(ht);
        var e = L();
        Vt(e, t),
          $t(e, "hidden"),
          (function (t, e) {
            ...
            u || E(),
              k.props.aria && A().removeAttribute("aria-".concat(k.props.aria)),
  ...
  function le(t, e) {
    Ut(e || {}, rt),
      ce ||
        (document.addEventListener("touchstart", St, lt),
  ...
  var ge = (function (t, e, n, r, i, o, a, p, s, c) {
    ...
    })(
      {
        render: function () {
          ...
          return n(
            t.tag,
            { tag: "component", attrs: { "data-tippy-component": "" } },
            [
              n(
                t.triggerTag || t.tag,
                {
                  ref: "trigger",
                  tag: "component",
                  attrs: { "data-tippy-component-trigger": "" },
                },
                [t._t("trigger")],
                2,
              ),
      ...
      void 0,
      {
        ...
        watch: {
          ...
          enabled: function (t) {
            this.tip &&
              (t ? this.tip.enable() : (this.tip.hide(), this.tip.disable()));
          },
          visible: function (t) {
        ...
        methods: {
          init: function () {
            ...
            if (
              (null == t &&
                (t = this.to
                  ? document.querySelector("[name='".concat(this.to, "']"))
                  : this.toSelector
                    ? document.querySelector(this.toSelector)
                    : this.$refs.trigger &&
              ...
              if (e) {
                ...
                (this.tip = e),
                  ...
                  !1 === this.enabled && this.tip.disable(),
          ...
          filterOptions: function () {
            for (
              var t = function (t, e) {
                ...
                e = 0,
                n = Object.keys(this.options);
              e < n.length;
              e++
            ) {
              var r = n[e];
              ve.hasOwnProperty(r)
                ? (this.options[r] = t(r, this.options[r]))
          ...
          getOptions: function () {
            ...
            return (
              (this.options.content = this.content
                ? this.content
                : this.$refs.content),
              Object.assign(this.options, ue.camelizeKeys(this.$attrs)),
              this.filterOptions(),
              !this.options.onShow &&
                this.$listeners &&
                this.$listeners.show &&
            ...
            inserted: function (r, i, o) {
              t.nextTick(function () {
                !(function (r, i, o) {
                  var a =
                    (o.data && o.data.on) ||
                    (o.componentOptions && o.componentOptions.listeners);
                  r.setAttribute("data-tippy-directive", "");
                  var p = n(i),
                  ...
                  (p = Object.assign({}, e, p)),
                    c && (p.placement = p.placement || c),
                    l && (p.arrow = void 0 === p.arrow || p.arrow),
                    a &&
                      a.show &&
                      (p.onShow = function () {
                        var t;
                    ...
                    r.getAttribute("title") &&
                      !p.content &&
                      ((p.content = r.getAttribute("title")),
                      r.removeAttribute("title")),
                    r.getAttribute("content") &&
                      !p.content &&
                      (p.content = r.getAttribute("content")),
                    le(r, p),
                    p.showOnLoad && r._tippy.show(),
                    t.nextTick(function () {
            ...
            componentUpdated: function (t, e, r) {
              if (t._tippy) {
                ...
                t.getAttribute("title") &&
                  !i.content &&
                  ((i.content = t.getAttribute("title")),
                  t.removeAttribute("title")),
                  t.getAttribute("content") &&
                    !i.content &&
                    (i.content = t.getAttribute("content")),
                  t._tippy.set(i);
              }
            },
          });
  ...
  return (
    "undefined" != typeof window &&
      window.Vue &&
      (window.Vue.use(we), window.Vue.component("tippy", ge)),
    (t.TippyComponent = ge),
    (t.default = we),
    (t.tippy = le),
    t
