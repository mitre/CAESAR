!(function (t, e) {
  ...
  !(function () {
    ...
    (function () {
      ...
      return (
        ...
        ((t.prototype = window.Event.prototype), void (window.CustomEvent = t))
      );
    })(),
    (function (t) {
      function e(e, i) {
        i = i || { bubbles: !1, cancelable: !1 };
  ...
  var n = function (t, e) {
    ...
    l = function t(e, i, o, s) {
      function r(t) {
        t.stopPropagation(),
          ...
          l.eventBus.dispatchEvent(
            new CustomEvent("handlestart", { detail: { handle: l } }),
          );
      }
      function a(t) {
        t.stopPropagation(),
          ...
          l.eventBus.dispatchEvent(
            new CustomEvent("handleend", { detail: { handle: l } }),
          );
      }
      function h(t) {
        t.stopPropagation(),
          l.eventBus.dispatchEvent(
            new CustomEvent("handlemove", {
              detail: { mouseX: t.clientX, mouseY: t.clientY },
            }),
          );
      }
      n(this, t);
      ...
      (this.position = e),
        ...
        (this.el.style.cursor = o),
        this.el.addEventListener("mousedown", r);
    },
    u = (function () {
      function t(e, i, o, s) {
              ...
              var t =
                ...
                n =
                  arguments.length > 3 && void 0 !== arguments[3]
                    ...
                    : null;
              return (
                (this.x1 = null == t ? this.x1 : t),
                (this.y1 = null == e ? this.y1 : e),
                (this.x2 = null == i ? this.x2 : i),
                (this.y2 = null == n ? this.y2 : n),
                this
              );
            },
          },
    ...
    d = [
      { position: [0, 0], constraints: [1, 0, 0, 1], cursor: "nw-resize" },
      { position: [0.5, 0], constraints: [1, 0, 0, 0], cursor: "n-resize" },
      { position: [1, 0], constraints: [1, 1, 0, 0], cursor: "ne-resize" },
      { position: [1, 0.5], constraints: [0, 1, 0, 0], cursor: "e-resize" },
      { position: [1, 1], constraints: [0, 1, 1, 0], cursor: "se-resize" },
      { position: [0.5, 1], constraints: [0, 0, 1, 0], cursor: "s-resize" },
      { position: [0, 1], constraints: [0, 0, 1, 1], cursor: "sw-resize" },
      { position: [0, 0.5], constraints: [0, 0, 0, 1], cursor: "w-resize" },
    ],
    c = (function () {
      function e(t, i) {
        var o = this,
        ...
        if (
          (n(this, e),
          (this.options = e.parseOptions(i || {})),
          !t.nodeName && ((t = document.querySelector(t)), null == t))
        )
          ...
          [
            ...
            },
            {
              ...
              value: function (e) {
                (this.containerEl = document.createElement("div")),
                  ...
                  this.imageEl.setAttribute("src", e.getAttribute("src")),
                  this.imageEl.setAttribute("alt", e.getAttribute("alt")),
            ...
            },
            {
              ...
              value: function (t) {
                var e = t.startSize.width,
                  ...
                  n = new u(0, 0, e, i);
                n.constrainToRatio(t.aspectRatio, [0.5, 0.5]);
                var o = t.minSize,
                  s = t.maxSize;
                n.constrainToSize(
                  s.width,
                ...
                n.constrainToBoundary(r, a, [0.5, 0.5]);
            ...
            },
            {
              ...
              value: function () {
                ...
                window.requestAnimationFrame(function () {
                  (t.regionEl.style.transform =
                    "translate(" + n + "px, " + o + "px)"),
                    (t.regionEl.style.width = e + "px"),
                    (t.regionEl.style.height = i + "px"),
                    (t.imageClippedEl.style.clip =
                      "rect(" +
                      o +
                      "px, " +
                      s +
                      ...
                      "px)");
                  for (
                    var a = t.box.getAbsolutePoint([0.5, 0.5]),
                      h = (a[0] - t.cropperEl.offsetWidth / 2) >> 31,
                      l = (a[1] - t.cropperEl.offsetHeight / 2) >> 31,
                      u = (h ^ l) + l + l + 4,
                      d = -2 * u + 8,
                      c = 0;
                    c < t.handles.length;
                    ...
                    var v = t.handles[c],
                      p = v.el.offsetWidth,
                      m = v.el.offsetHeight,
                      f = n + e * v.position[0] - p / 2,
                      g = o + i * v.position[1] - m / 2;
            ...
            },
            {
              ...
              value: function () {
                ...
                var n = this.eventBus;
                this.regionEl.addEventListener("mousedown", t),
                  n.addEventListener(
                    "regionstart",
              ...
              value: function () {
                function t(t) {
                  ...
                  var r = o.cropperEl.getBoundingClientRect(),
                    ...
                    h = t.clientY - r.top;
                  (s = o.box),
                    (o.box = new u(a, h, a + 1, h + 1)),
                    o.eventBus.dispatchEvent(
                      new CustomEvent("handlestart", {
                        detail: { handle: o.handles[n] },
                      }),
                    );
                }
                function e(t) {
                ...
                function i(t) {
                  return (
                    ...
                    document.removeEventListener("mouseup", i),
                    document.removeEventListener("mousemove", e),
                    1 === o.box.width() && 1 === o.box.height()
                      ? void (o.box = s)
                      : void o.eventBus.dispatchEvent(
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (i -= o.left),
                  (n -= o.top),
                  i < 0 ? (i = 0) : i > o.width && (i = o.width),
                  n < 0 ? (n = 0) : n > o.height && (n = o.height);
                ...
                if (this.options.aspectRatio) {
                  var z = this.options.aspectRatio,
                    M = !1;
                  p
                    ? (M = n > C.y1 + z * C.width() || n < C.y2 - z * C.width())
                    : (l || c) && (M = !0);
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (i -= a.left),
                  (n -= a.top),
                  this.box.move(i - s, n - r),
                  this.box.x1 < 0 && this.box.move(0, null),
                  this.box.x2 > a.width &&
                    this.box.move(a.width - this.box.width(), null),
                  this.box.y1 < 0 && this.box.move(null, 0),
                  this.box.y2 > a.height &&
                    this.box.move(null, a.height - this.box.height()),
                  this.redraw(),
                  null !== this.options.onCropMove &&
                    this.options.onCropMove(this.getValue());
              },
              ...
              value: function () {
                var t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    : null;
                if (
                  (null === t && (t = this.options.returnMode), "real" == t)
                ) {
                  var e = this.imageEl.naturalWidth,
                    n = this.imageEl.naturalHeight,
                    o = e / this.imageEl.offsetWidth,
                    s = n / this.imageEl.offsetHeight;
                  return {
                    x: Math.round(this.box.x1 * o),
                    y: Math.round(this.box.y1 * s),
                    width: Math.round(this.box.width() * o),
                    height: Math.round(this.box.height() * s),
                  };
                }
                if ("ratio" == t) {
                  var r = this.imageEl.offsetWidth,
                    a = this.imageEl.offsetHeight;
                  return {
                    x: i(this.box.x1 / r, 3),
                    y: i(this.box.y1 / a, 3),
                    width: i(this.box.width() / r, 3),
                    height: i(this.box.height() / a, 3),
                  };
                }
                if ("raw" == t)
                  return {
          ...
          [
            {
              ...
              value: function (t) {
                var e = {
                  ...
                  i = null;
                void 0 !== t.aspectRatio &&
                  ("number" == typeof t.aspectRatio
                    ? (i = t.aspectRatio)
                    : t.aspectRatio instanceof Array &&
                      (i = t.aspectRatio[1] / t.aspectRatio[0]));
                var n = null;
                void 0 !== t.maxSize &&
                  null !== t.maxSize &&
                  (n = {
                ...
                "function" == typeof t.onUpdate &&
                  ...
                  (l = t.onUpdate)),
                  "function" == typeof t.onCropMove && (l = t.onCropMove);
                var u = null;
                if (void 0 !== t.returnMode) {
                  var d = t.returnMode.toLowerCase();
                  if (["real", "ratio", "raw"].indexOf(d) === -1)
                ...
                var c = function (t) {
                    for (
                      ...
                      null !== this[s] &&
                        ("%" == this[s].unit &&
                          (null !== this[s].width &&
                            (this[s].width = (this[s].width / 100) * e),
                          null !== this[s].height &&
                            (this[s].height = (this[s].height / 100) * i)),
                        delete this[s].unit);
                    }
                  },
                  v = function (t, e) {
                ...
                return {
                  aspectRatio: v(i, e.aspectRatio),
                  maxSize: v(n, e.maxSize),
                  minSize: v(o, e.minSize),
                  startSize: v(s, e.startSize),
                  returnMode: v(u, e.returnMode),
                  onInitialize: v(r, e.onInitialize),
                  onCropStart: v(a, e.onCropStart),
                  onCropMove: v(l, e.onCropMove),
                  onCropEnd: v(h, e.onCropEnd),
                  convertToPixels: c,
                };
              },
            },
    ...
    v = (function (t) {
      function e(t, i) {
        ...
        return (
          n(this, e),
          a(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i, o))
        );
      }
      return (
        r(e, t),
