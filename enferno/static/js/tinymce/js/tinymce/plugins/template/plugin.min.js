    ...
    T = function (e, t, n) {
      ...
      return (
        ...
        (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
          ...
          "%y",
          "" + n.getYear(),
        )).replace("%m", c(n.getMonth() + 1, 2))).replace(
          "%d",
          c(n.getDate(), 2),
        )).replace("%H", "" + c(n.getHours(), 2))).replace(
          "%M",
          "" + c(n.getMinutes(), 2),
        )).replace("%S", "" + c(n.getSeconds(), 2))).replace(
          "%I",
          "" + (((n.getHours() + 11) % 12) + 1),
        )).replace("%p", n.getHours() < 12 ? "AM" : "PM")).replace(
          "%B",
          "" + e.translate(u[n.getMonth()]),
        )).replace("%b", "" + e.translate(a[n.getMonth()]))).replace(
          "%A",
          "" + e.translate(o[n.getDay()]),
