(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("./empty"), require("./empty"))
    : typeof define === "function" && define.amd
      ? define(["exports", "./empty", "./empty"], factory)
      : factory(
          (global.jsondiffpatch = {}),
          global["diff-match-patch"],
          global.chalk,
        );
  ...
  var DiffContext = (function (_Context) {
    ...
    function DiffContext(left, right) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (DiffContext.__proto__ || Object.getPrototypeOf(DiffContext)).call(
          this,
        ),
      );
  ...
  var PatchContext = (function (_Context) {
    ...
    function PatchContext(left, delta) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (PatchContext.__proto__ || Object.getPrototypeOf(PatchContext)).call(
          this,
        ),
      );
  ...
  var ReverseContext = (function (_Context) {
    ...
    function ReverseContext(delta) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (
          ReverseContext.__proto__ || Object.getPrototypeOf(ReverseContext)
        ).call(this),
      );
...
*/
      ...
      },
      {
        ...
        value: function getDeltaType(delta, movedFrom) {
          ...
          if (isArray$3(delta)) {
            ...
            (typeof delta === "undefined" ? "undefined" : _typeof(delta)) ===
            "object"
          ) {
            return "node";
          }
  ...
  var JSONFormatter = (function (_BaseFormatter) {
    ...
    function JSONFormatter() {
      ...
      var _this = possibleConstructorReturn(
        this,
        (JSONFormatter.__proto__ || Object.getPrototypeOf(JSONFormatter)).call(
          this,
        ),
      );
  ...
  var ConsoleFormatter = (function (_BaseFormatter) {
    ...
    function ConsoleFormatter() {
      ...
      var _this = possibleConstructorReturn(
        this,
        (
          ConsoleFormatter.__proto__ || Object.getPrototypeOf(ConsoleFormatter)
        ).call(this),
      );
